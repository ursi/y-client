...
(function($PS) {
  ...
  var borderWidth = declaration("border-width");       
...
(function($PS) {
  ...
  var staticStyles = Css_Global.style([ Css_Global.body([ Css_Variables.mkVarStyles()(varRec), Css.margin("0"), Css.fontFamily("monospace") ]) ]);
...
(function($PS) {
  ...
  var processEvents = function ($107) {
      return (function (v) {
          return {
              ...
              messages: TreeMap.toTreeMap(Y_Shared_Id.ordId)(Data_Functor.mapFlipped(Data_List_Types.functorList)(v.messageEvents)(function ($108) {
  ...
  var inputWithHeight = Attribute.on(Producer.produceab)("input")((function () {
      var $109 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(NoOp.value))(function (elem) {
          return Control_Apply.lift2(Effect.applyEffect)(function (content) {
              return function (height) {
                  return new UpdateInputBox({
                      content: content,
                      height: height + 2.0 * Design.inputBoxBorderWidth
                  });
              };
      ...
      var $110 = WHATWG_HTML_Types.toMaybeHTMLTextAreaElement();
      var $111 = WHATWG_DOM_Event.unsafeTarget();
      return function ($112) {
          return $109($110($111($112)));
      };
  })());
  var inputId = "input";
  ...
  var detectSendMessage = Attribute.on(Producer.produceab)("keydown")((function () {
      var $113 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(NoOp.value))(function (kbe) {
          var $56 = WHATWG_HTML_KeyboardEvent.key(kbe) === "Enter" && (WHATWG_HTML_KeyboardEvent.ctrlKey(kbe) || WHATWG_HTML_KeyboardEvent.metaKey(kbe));
          if ($56) {
              return function __do() {
      ...
      var $114 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($115) {
          return $113($114($115));
      };
  })());
  ...
  var addEvents = function (events) {
      return function (newEvents) {
          ...
          if (oldEnd instanceof Data_Maybe.Just && newHead instanceof Data_Maybe.Just) {
              var $65 = Data_Ord.lessThanOrEq(Y_Shared_Util_Instant.ordInstant)(oldEnd.value0.time)(newHead.value0.time);
              if ($65) {
  ...
  var update = function (v) {
      ...
      var focusInput = Platform.afterRender(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(WHATWG_HTML_Window.window)(WHATWG_HTML_Window.document))((function () {
          var $116 = Data_Functor.map(Effect.functorEffect)(WHATWG_HTML_Types.toMaybeHTMLElement());
          var $117 = WHATWG_DOM_Mixin_NonElementParentNode.getElementById()(inputId);
          return function ($118) {
              return $116($117($118));
          };
  ...
  var nameChanger = function (model) {
      return Html.divS([ Css.margin(".3em") ])([  ])([ Html.input([ Attribute.value(model.nameInput), Attribute.onInput(Producer.produceab)(UpdateNameInput.create) ]), Html.button([ Attribute.onClick(Producer.producea($dollar_EqMsg_32))(UpdateName.value) ])([ Html.text("Update Name") ]) ]);
  };
  var threadBar = function (model) {
      ...
      return Platform.batch([ Html.divS([ Css.margin("5px") ])([  ])([ Html.button([ Attribute.onClick(Producer.producea($dollar_EqMsg_32))(NewThread.value) ])([ Html.text("New Thread") ]) ]), Html.divS([ Css.overflow("auto"), Css.borderJ([ Design.vars.borderWidth1, "solid" ]) ])([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(leaves)(function (mid) {
          return (function (mes) {
              return Html.divS([ (function () {
                  var $100 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.selectedThreadRoot)(new Data_Maybe.Just(mid));
                  if ($100) {
                      return Css.background(Design.vars.red1);
                  };
                  return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]);
              })(), Design.following([ Css.borderTop("1px solid") ]), Css.padding(".3em"), Css.whiteSpace("pre-wrap"), Css.overflow("auto") ])([ Attribute.onClick(Producer.producea($dollar_EqMsg_32))(new SelectThreadRoot(mid)) ])([ Html.text(mes) ]);
          })(Data_Maybe.maybe("oops")(function ($119) {
              return (function (v) {
                  return v.content;
              })((function (v) {
                  return v.value;
              ...
              var createMessage = function (styles) {
                  return function (mes) {
                      return Html.divS([ Design.following([ Css.borderBottom("1px solid") ]), Css.padding(".25em"), Css.position("relative"), styles ])([ Attribute.onClick(Producer.producea($dollar_EqMsg_32))(new SelectMessageParent(mes.id)) ])([ (function () {
                          ...
                          return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]);
                      })(), Html.divS([ Css.font("0.72em sans-serif"), Css.opacity("0.6"), Css.marginBottom("0.7em"), Css.paddingTop("1px") ])([  ])([ Html.text(Data_Maybe.fromMaybe("<anonymous>")(Data_Map_Internal.lookup(Y_Shared_Id.ordId)(mes.authorId)(model.state.names))) ]), Html.divS([ Css.whiteSpace("pre-wrap"), Css.position("relative") ])([  ])([ Html.text(mes.content) ]) ]);
                  };
              };
