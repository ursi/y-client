...
(function($PS) {
  ...
  var panel = Platform.batch([ Css.display("grid"), Css.gridTemplateRows("fit-content(100%)") ]);
...
(function($PS) {
      ...
      return function (v2) {
          ...
          if (v2 instanceof TransmissionReceived) {
              if (v2.value0 instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Main (line 259, column 9 - line 272, column 33): " + [ v.selectedThreadRoot.constructor.name ]);
              };
              if (v2.value0 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v);
              };
              throw new Error("Failed pattern match at Main (line 236, column 33 - line 274, column 28): " + [ v2.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Main (line 152, column 3 - line 282, column 23): " + [ v2.constructor.name ]);
      };
  };
  ...
  var threadBar = function (model) {
      ...
      return Html.divS([ Design.panel ])([  ])([ Html.div([  ])([ Html.button([ Attribute.onClick(Producer.producea($dollar_EqMsg_32))(NewThread.value) ])([ Html.text("New Thread") ]), Html.divS([ Css.margin(".3em") ])([  ])([ Html.input([ Attribute.value(model.nameInput), Attribute.onInput(Producer.produceab)(UpdateNameInput.create) ]), Html.button([ Attribute.onClick(Producer.producea($dollar_EqMsg_32))(UpdateName.value) ])([ Html.text("Update Name") ]) ]) ]), Html.divS([ Css.overflow("auto") ])([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(leaves)(function (mid) {
          return (function (mes) {
  ...
  var threadView = function (model) {
      ...
      throw new Error("Failed pattern match at Main (line 489, column 3 - line 550, column 28): " + [ mthread.constructor.name ]);
  };
  ...
  exports["NoOp"] = NoOp;
  exports["defaultInputBox"] = defaultInputBox;
  ...
  exports["inputWithHeight"] = inputWithHeight;
  exports["detectSendMessage"] = detectSendMessage;
