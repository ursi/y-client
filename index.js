...
(function($PS) {
  ...
  var processEvents = function ($130) {
      return (function (v) {
          return {
              ...
              messages: TreeMap.toTreeMap(Y_Shared_Id.ordId)(Data_Functor.mapFlipped(Data_List_Types.functorList)(v.messageEvents)(function ($131) {
  ...
  var inputWithHeight = Attribute.on(Producer.produceab)("input")((function () {
      var $132 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (elem) {
      ...
      var $133 = WHATWG_HTML_Types.toMaybeHTMLTextAreaElement();
      var $134 = WHATWG_DOM_Event.unsafeTarget();
      return function ($135) {
  ...
  var hitEnter = (function () {
      var $136 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (kbe) {
          var $64 = WHATWG_HTML_KeyboardEvent.key(kbe) === "Enter";
          if ($64) {
              return function __do() {
                  ...
                  return Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (activeElement) {
                      var $65 = Data_Eq.eq(RefEq.eqRefEq)(new RefEq.RefEq(body))(new RefEq.RefEq(activeElement));
                      if ($65) {
                          return function __do() {
      ...
      var $137 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($138) {
          return $136($137($138));
      };
  })();
  ...
  var formatTimeDiff = function (iOld) {
      return function (iNew) {
          ...
          var $69 = Data_Int.round(seconds) < 120;
          if ($69) {
              return show$prime(seconds)("s");
          };
          var minutes = seconds / 60.0;
          var $70 = Data_Int.round(minutes) < 120;
          if ($70) {
  ...
  var detectSendMessage = Attribute.on(Producer.produceab)("keydown")((function () {
      var $139 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (kbe) {
          var $74 = WHATWG_HTML_KeyboardEvent.key(kbe) === "Enter" && (WHATWG_HTML_KeyboardEvent.ctrlKey(kbe) || WHATWG_HTML_KeyboardEvent.metaKey(kbe));
          if ($74) {
              return function __do() {
                  WHATWG_DOM_Event.preventDefault()(kbe)();
      ...
      var $140 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($141) {
          return $139($140($141));
      };
  })());
  ...
  var addEvents = function (events) {
      return function (newEvents) {
          ...
          if (oldEnd instanceof Data_Maybe.Just && newHead instanceof Data_Maybe.Just) {
              var $83 = Data_Ord.lessThanOrEq(Y_Shared_Util_Instant.ordInstant)(oldEnd.value0.time)(newHead.value0.time);
              if ($83) {
  ...
  var update = function (v) {
      ...
      var focusInput = Platform.afterRender(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(WHATWG_HTML_Window.window)(WHATWG_HTML_Window.document))((function () {
          var $142 = Data_Functor.map(Effect.functorEffect)(WHATWG_HTML_Types.toMaybeHTMLElement());
          var $143 = WHATWG_DOM_Mixin_NonElementParentNode.getElementById()(inputId);
          return function ($144) {
              return $142($143($144));
          };
      ...
      return function (v2) {
          ...
          if (v2 instanceof TransmissionReceived) {
              if (v2.value0 instanceof Data_Maybe.Just) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(function (mes) {
                      var $101 = Data_Eq.eq(Y_Shared_Id.eqId)(mes.authorId)(v.userId);
                      if ($101) {
                          return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                      };
                      ...
                      throw new Error("Failed pattern match at Main (line 291, column 11 - line 304, column 35): " + [ v.thread.constructor.name ]);
                  });
              };
              if (v2.value0 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v);
              };
              throw new Error("Failed pattern match at Main (line 249, column 7 - line 306, column 30): " + [ v2.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Main (line 158, column 3 - line 314, column 23): " + [ v2.constructor.name ]);
      };
  };
  var $dollar_EqMsg_41 = new Data_Eq.Eq(function (v) {
      return function (v1) {
  ...
  var threadBar = function (model) {
      ...
      return Platform.batch([ Html.divS([ Css.margin("5px") ])([  ])([ Html.button([ Attribute.onClick(Producer.producea($dollar_EqMsg_41))(NewThread.value) ])([ Html.text("New Thread") ]) ]), Html.divS([ Css.overflow("auto"), Css.borderJ([ Design.vars.borderWidth1, "solid" ]) ])([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(leaves)(function (mid) {
          return (function (mes) {
              return Html.divS([ (function () {
                  var $122 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.thread)(new Data_Maybe.Just(mid));
                  if ($122) {
                      return Css.background(Design.vars.accent1);
                  };
                  return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]);
              })(), Design.following([ Css.borderTop("1px solid") ]), Css.padding(".3em"), Css.whiteSpace("pre-wrap"), Css.overflow("auto") ])([ Attribute.onClick(Producer.producea($dollar_EqMsg_41))(new SelectThreadRoot(mid)) ])([ Html.text(mes) ]);
          })(Data_Maybe.maybe("oops")(function ($145) {
              return (function (v) {
                  return v.content;
              })((function (v) {
                  return v.value;
  ...
  var threadView = function (model) {
      ...
      var messageList = (function () {
          var $146 = Data_Functor.map(Data_Functor.functorArray)(function (v) {
              var createMessage = function (isSibling) {
                  return function (styles) {
                      return function (mes) {
                          return Html.divS([ Design.following([ Css.borderBottom("1px solid") ]), Css.padding(".25em"), Css.position("relative"), Css.paddingBottom("6px"), styles ])([ Attribute.onClick(Producer.producea($dollar_EqMsg_41))((function () {
                              if (isSibling) {
                          ...
                          })(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(getParent(mes)(model.state.messages))(PointFree.applySecond(function ($149) {
          ...
          var $147 = Data_Array.fromFoldable(Data_List_Types.foldableNonEmptyList);
          return function ($148) {
      ...
      return Html.divS([ Design.panel, Css.transform(Css_Functions.translateX(Css_Functions.calc(Css_Functions.sub("0px")(Design.vars.borderWidth1)))) ])([  ])([ (function () {
          ...
          throw new Error("Failed pattern match at Main (line 550, column 7 - line 552, column 26): " + [ mthread.constructor.name ]);
      })(), messageInput ]);
  };
