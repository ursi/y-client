...
(function($PS) {
  ...
  var mapBoth = function (f) {
      return function (v) {
          if (v instanceof Single) {
              return Single.create(f(v.value0));
          };
          if (v instanceof Batch) {
              return Batch.create(Data_Functor.map(Data_Functor.functorArray)(mapBoth(f))(v.value0));
          };
          ...
          return function (u) {
              return function (xs) {
                  return Data_Newtype.unwrap()(Data_Newtype.unwrap()(foldMap(dictNestedFoldable)(Data_Monoid_Dual.monoidDual(Data_Monoid_Endo.monoidEndo(Control_Category.categoryFn)))((function () {
                      var $38 = Data_Function.flip(c);
                      return function ($39) {
                          return Data_Monoid_Dual.Dual(Data_Monoid_Endo.Endo($38($39)));
                      };
                  })())(xs)))(u);
              };
          };
  ...
  var foldrDefault = function (dictNestedFoldable) {
      return function (c) {
          return function (u) {
              return function (xs) {
                  return Data_Newtype.unwrap()(foldMap(dictNestedFoldable)(Data_Monoid_Endo.monoidEndo(Control_Category.categoryFn))(function ($40) {
                      return Data_Monoid_Endo.Endo(c($40));
                  })(xs))(u);
              };
          };
      };
  };
  var $dollar_SemigroupBatched_7 = new Data_Semigroup.Semigroup(function (b1) {
      return function (b2) {
  ...
  var $dollar_NestedFoldableBatched_9 = new NestedFoldable(function (dictMonoid) {
      return function (ab2m) {
          return function (v) {
              ...
              if (v instanceof Batch) {
                  return Data_Foldable.foldMap(Data_Foldable.foldableArray)(dictMonoid)(foldMap($dollar_NestedFoldableBatched_9)(dictMonoid)(ab2m))(v.value0);
              };
              throw new Error("Failed pattern match at Data.Batched (line 57, column 18 - line 59, column 51): " + [ v.constructor.name ]);
          };
      };
  }, function (f) {
      return foldlDefault($dollar_NestedFoldableBatched_9)(f);
  }, function (f) {
      return foldrDefault($dollar_NestedFoldableBatched_9)(f);
  });
  var flattenMap = function (f) {
      return foldr($dollar_NestedFoldableBatched_9)(function ($41) {
          return Data_List_Types.Cons.create(f($41));
      })(Data_List_Types.Nil.value);
  };
  var flatten = flattenMap(Control_Category.identity(Control_Category.categoryFn));
  var $dollar_MonoidBatched_8 = new Data_Monoid.Monoid(function () {
      return $dollar_SemigroupBatched_7;
  }, new Batch([  ]));
  var $dollar_FunctorBatched_4 = function (dictFunctor) {
      return new Data_Functor.Functor(function (f) {
          return function (v) {
              if (v instanceof Single) {
              ...
              if (v instanceof Batch) {
                  return Batch.create(Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map($dollar_FunctorBatched_4(dictFunctor))(f))(v.value0));
              };
              throw new Error("Failed pattern match at Data.Batched (line 17, column 11 - line 19, column 39): " + [ v.constructor.name ]);
          };
      });
  };
  var $dollar_ApplyBatched_5 = function (dictApply) {
      return new Control_Apply.Apply(function () {
          return $dollar_FunctorBatched_4(dictApply.Functor0());
      }, function (batched_af) {
          return function (batched_ab) {
              ...
              if (batched_af instanceof Batch) {
                  return Batch.create(Data_Functor.mapFlipped(Data_Functor.functorArray)(batched_af.value0)(function (batched_af$prime) {
                      return Control_Apply.apply($dollar_ApplyBatched_5(dictApply))(batched_af$prime)(batched_ab);
                  }));
              };
              if (batched_ab instanceof Batch) {
                  return Batch.create(Data_Functor.map(Data_Functor.functorArray)(Control_Apply.apply($dollar_ApplyBatched_5(dictApply))(batched_af))(batched_ab.value0));
              };
  ...
  var $dollar_ApplicativeBatched_6 = function (dictApplicative) {
      return new Control_Applicative.Applicative(function () {
          return $dollar_ApplyBatched_5(dictApplicative.Apply0());
      }, (function () {
          var $42 = Control_Applicative.pure(dictApplicative);
          return function ($43) {
              return Single.create($42($43));
          };
      })());
  };
  ...
  exports["$_FunctorBatched_4"] = $dollar_FunctorBatched_4;
  exports["$_ApplicativeBatched_6"] = $dollar_ApplicativeBatched_6;
  exports["$_SemigroupBatched_7"] = $dollar_SemigroupBatched_7;
  exports["$_MonoidBatched_8"] = $dollar_MonoidBatched_8;
})(PS);
(function(exports) {
...
(function($PS) {
  ...
  var window$prime = $foreign.windowPrime;
  var document$prime = WHATWG_Internal.unsafeGet("document")(window$prime);
  var document = WHATWG_Internal.unsafeGet("document");
  exports["document"] = document;
  exports["document'"] = document$prime;
...
(function($PS) {
  ...
  var makeListener = function (toEventCallback) {
      return function (event) {
          return function (send) {
              return function __do() {
                  var window = WHATWG_HTML_Window.window();
                  var callback = Effect_Uncurried.mkEffectFn1(toEventCallback(send));
                  WHATWG_DOM_EventTarget.addEventListener()()(event)(callback)({})(window)();
                  return WHATWG_DOM_EventTarget.removeEventListener()()(event)(callback)({})(window);
              };
          };
      };
  };
  var onRefEq = function (handlerP) {
      return makeListener(function (msgCallback) {
          return function (event) {
              return function __do() {
                  var mmsg = Producer.produce(Producer.produceProducer)(handlerP)(event)();
                  if (mmsg instanceof Data_Maybe.Just) {
                      return msgCallback(mmsg.value0)();
                  };
                  if (mmsg instanceof Data_Maybe.Nothing) {
                      return Data_Unit.unit;
                  };
  ...
  var on = function (dictProduce) {
      return function (eventName) {
          return function (toMsg) {
              return Data_Batched.Single.create(SingleSub(Producer.producer2(Data_Tuple.eqTuple(Producer.eqProducer)(Data_Eq.eqString))(onRefEq)(Producer.lift(dictProduce)(toMsg))(eventName)));
          };
      };
  };
...
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  $PS["MasonPrelude.Functor.Nested"] = $PS["MasonPrelude.Functor.Nested"] || {};
  var exports = $PS["MasonPrelude.Functor.Nested"];
  var Data_Functor = $PS["Data.Functor"];
  var mmap = function (dictFunctor) {
      return function (dictFunctor1) {
          var $14 = Data_Functor.map(dictFunctor);
          var $15 = Data_Functor.map(dictFunctor1);
          return function ($16) {
              return $14($15($16));
          };
      };
...
(function($PS) {
  ...
  var scrollHeight = function (dictIsElement) {
      return WHATWG_Internal.unsafeGet("scrollHeight");
  };
...
(function($PS) {
  ...
  var toMaybeKeyboardEvent = function (dictMaybeKeyboardEvent) {
      return WHATWG_Internal.unsafeConvert("KeyboardEvent");
  };
  var toMaybeHTMLTextAreaElement = function (dictMaybeHTMLTextAreaElement) {
      return WHATWG_Internal.unsafeConvert("HTMLTextAreaElement");
  };
  ...
  exports["toMaybeKeyboardEvent"] = toMaybeKeyboardEvent;
  exports["toEventTarget"] = toEventTarget;
  exports["toNode"] = toNode;
  exports["toElement"] = toElement;
  exports["toMaybeHTMLElement"] = toMaybeHTMLElement;
  exports["toMaybeHTMLTextAreaElement"] = toMaybeHTMLTextAreaElement;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  ...
  var MasonPrelude_Functor_Nested = $PS["MasonPrelude.Functor.Nested"];
  var MyMap = $PS["MyMap"];
  var Safe_Coerce = $PS["Safe.Coerce"];
  ...
  var AlwaysSet = (function () {
      function AlwaysSet(value0) {
          this.value0 = value0;
      };
      AlwaysSet.create = function (value0) {
          return new AlwaysSet(value0);
      };
      return AlwaysSet;
  })();
  ...
  var setAttributes = function (attribute) {
      return function (elem) {
              ...
              return function ($copy_v) {
                  ...
                  function $tco_loop(acc, v) {
                      ...
                      if (v instanceof Listener) {
                          $tco_done = true;
                          return Control_Applicative.pure(Effect.applicativeEffect)(Data_Semigroup.append(Data_Batched["$_SemigroupBatched_7"])(acc)(v.value0(WHATWG_HTML_Types.toEventTarget()(elem))));
                      };
                      ...
                      throw new Error("Failed pattern match at VirtualDom (line 565, column 5 - line 579, column 30): " + [ v.constructor.name ]);
                  };
                  while (!$tco_done) {
                      $tco_result = $tco_loop($tco_var_acc, $copy_v);
                  };
          ...
          return Data_Foldable.foldM(Data_List_Types.foldableList)(Effect.monadEffect)(go)(Data_Monoid.mempty(Data_Batched["$_MonoidBatched_8"]))(attribute);
      };
  };
  var removeAttribute = function ($copy_attr) {
      return function ($copy_elem) {
          var $tco_var_attr = $copy_attr;
          var $tco_done = false;
          var $tco_result;
          function $tco_loop(attr, elem) {
              ...
              throw new Error("Failed pattern match at VirtualDom (line 453, column 3 - line 458, column 42): " + [ attr.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var getNode = function (v) {
      ...
      throw new Error("Failed pattern match at VirtualDom (line 470, column 11 - line 473, column 33): " + [ v.constructor.name ]);
  };
  ...
  var placeNodeHelper = function (placer) {
      return function (v) {
          return function (traverser) {
              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect))))(function (v1) {
                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Writer_Trans.monadEffectWriter(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect_Class.monadEffectEffect)))(WHATWG_DOM_Document.createElement()(v.tag)({})(v1.doc)))(function (elem) {
                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Writer_Trans.monadEffectWriter(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect_Class.monadEffectEffect)))(setAttributes(v.attributes)(elem)))(function (subs) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Control_Monad_Writer_Class.tell(Control_Monad_Reader_Trans.monadTellReaderT(Control_Monad_Writer_Trans.monadTellWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect)))(new Data_Tuple.Tuple(subs, Data_Monoid.mempty(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))))(function () {
                              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Writer_Trans.monadEffectWriter(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect_Class.monadEffectEffect)))(placer({
                                  node: WHATWG_HTML_Types.toNode()(elem),
                                  parent: v1.parent
                              })))(function () {
                                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Data_Traversable.traverse(Data_List_Types.traversableList)(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))((function () {
                                      var $218 = Control_Monad_Reader_Class.local(Control_Monad_Reader_Trans.monadReaderReaderT(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect)))(changeParent(elem));
                                      return function ($219) {
                                          return $218(traverser($219));
                                      };
                                  })())(v.children))(function (newChildren) {
                                      return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(new Data_Tuple.Tuple(newChildren, elem));
                                  });
                              });
                          });
                      });
  ...
  var addCss = function (v) {
      if (v instanceof Data_Maybe.Just) {
          return Control_Monad_Writer_Class.tell(Control_Monad_Reader_Trans.monadTellReaderT(Control_Monad_Writer_Trans.monadTellWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect)))(new Data_Tuple.Tuple(Data_Monoid.mempty(Data_Batched["$_MonoidBatched_8"]), Safe_Coerce.coerce()(v.value0)));
      };
      if (v instanceof Data_Maybe.Nothing) {
          return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(Data_Unit.unit);
      };
      throw new Error("Failed pattern match at VirtualDom (line 543, column 10 - line 545, column 23): " + [ v.constructor.name ]);
  };
  var placeNode = function (placer) {
      return function (svn) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect))))(function (v) {
              if (svn instanceof VElement) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(addCss(svn.value0.css))(function () {
                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(placeNodeHelper(placer)(svn.value0)(addNode))(function (v1) {
                          return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(VElement.create({
                              tag: svn.value0.tag,
              ...
              if (svn instanceof KeyedElement) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(addCss(svn.value0.css))(function () {
                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(placeNodeHelper(placer)(svn.value0)(addKeyedNode))(function (v1) {
                          return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(KeyedElement.create({
                              tag: svn.value0.tag,
                              styles: svn.value0.styles,
                              css: svn.value0.css,
                              attributes: svn.value0.attributes,
              ...
              if (svn instanceof VText) {
                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Writer_Trans.monadEffectWriter(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect_Class.monadEffectEffect)))(WHATWG_DOM_Document.createTextNode(svn.value0.text)(v.doc)))(function (node) {
                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Writer_Trans.monadEffectWriter(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect_Class.monadEffectEffect)))(placer({
                          ...
                          return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(new VText({
              ...
              throw new Error("Failed pattern match at VirtualDom (line 496, column 3 - line 516, column 53): " + [ svn.constructor.name ]);
          });
      };
  };
  ...
  var addKeyedNode = function (v) {
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(addNode(v.value1))(function (addedVNode) {
          return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(new Data_Tuple.Tuple(v.value0, addedVNode));
      });
  };
  var applyPatch = function (patch) {
      if (patch instanceof Remove) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect))))(function (v) {
              return Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Writer_Trans.monadEffectWriter(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect_Class.monadEffectEffect)))(function __do() {
      ...
      throw new Error("Failed pattern match at VirtualDom (line 125, column 20 - line 140, column 19): " + [ patch.constructor.name ]);
  };
  var removeVNode = function (svn) {
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Data_Maybe.fromMaybe(noNodeError(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Writer_Trans.monadEffectWriter(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect_Class.monadEffectEffect))))(Control_Bind.bind(Data_Maybe.bindMaybe)(getNode(svn))(function (node) {
  ...
  var addAttribute = function ($copy_attr) {
      return function ($copy_elem) {
          ...
          function $tco_loop(attr, elem) {
              if (attr instanceof Attr) {
                  $tco_done = true;
                  return Control_Monad_Trans_Class.lift(Control_Monad_Writer_Trans.monadTransWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString))))(Effect.monadEffect)(WHATWG_DOM_Element.setAttribute()(attr.value0)(attr.value1)(elem));
              };
              if (attr instanceof Prop) {
                  $tco_done = true;
                  return Control_Monad_Trans_Class.lift(Control_Monad_Writer_Trans.monadTransWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString))))(Effect.monadEffect)($foreign.setProperty(attr.value0)(attr.value1)(elem));
              };
              if (attr instanceof AddClass) {
                  $tco_done = true;
              ...
              throw new Error("Failed pattern match at VirtualDom (line 462, column 3 - line 467, column 39): " + [ attr.constructor.name ]);
          };
          while (!$tco_done) {
              $tco_result = $tco_loop($tco_var_attr, $copy_elem);
          };
  ...
  var diffAttributes = function (elem) {
      var diffBoth = function (force) {
          return function (sa1) {
              return function (sa2) {
                  var $$switch = function (v) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Writer_Trans.monadTransWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString))))(Effect.monadEffect)(removeAttribute(sa1)(elem)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect))(addAttribute(sa2)(elem))(function () {
                              return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect))(new Data_Maybe.Just(sa2));
                          });
                      });
                  };
                  var forceUpdate = function (v) {
                      if (force) {
                          return addAttribute(sa2)(elem);
                      };
                      return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect))(Data_Unit.unit);
                  };
                  if (sa1 instanceof Attr && sa2 instanceof Attr) {
                      var $114 = sa1.value0 === sa2.value0;
                      if ($114) {
                          var $115 = sa1.value1 === sa2.value1;
                          if ($115) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect))(forceUpdate(Data_Unit.unit))(function () {
                                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect))(new Data_Maybe.Just(sa1));
                              });
                          };
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect))(addAttribute(sa2)(elem))(function () {
                              return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect))(new Data_Maybe.Just(sa2));
                      ...
                      return $$switch(Data_Unit.unit);
                  };
                  if (sa1 instanceof AddClass && sa2 instanceof AddClass) {
                      var $120 = sa1.value0 === sa2.value0;
                      if ($120) {
                          return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect))(new Data_Maybe.Just(sa1));
                      };
                      return $$switch(Data_Unit.unit);
                  ...
                  if (sa1 instanceof Prop && sa2 instanceof Prop) {
                      var $123 = sa1.value0 === sa2.value0;
                      if ($123) {
                          var $124 = Data_Eq.eq(Data_JSValue["$_EqJSValue_0"])(sa1.value1)(sa2.value1);
                          if ($124) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect))(forceUpdate(Data_Unit.unit))(function () {
                                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect))(new Data_Maybe.Just(sa1));
                              });
                  ...
                  if (sa1 instanceof AlwaysSet && sa2 instanceof AlwaysSet) {
                      return MasonPrelude_Functor_Nested.mmap(Control_Monad_Writer_Trans.functorWriterT(Effect.functorEffect))(Data_Maybe.functorMaybe)(AlwaysSet.create)(diffBoth(true)(sa1.value0)(sa2.value0));
                  };
                  return $$switch(Data_Unit.unit);
              };
          };
      };
      return Data_Diff.diff(Data_Diff["$_DiffableList_2"])(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect))(function (v) {
          if (v instanceof Data_Diff.Left) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Writer_Trans.monadTransWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString))))(Effect.monadEffect)(removeAttribute(v.value0)(elem)))(function () {
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect))(Data_Maybe.Nothing.value);
              });
          };
          if (v instanceof Data_Diff.Right) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect))(addAttribute(v.value0)(elem))(function () {
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect))(new Data_Maybe.Just(v.value0));
              });
          };
          if (v instanceof Data_Diff.Both) {
              return diffBoth(false)(v.value0)(v.value1);
          };
          throw new Error("Failed pattern match at VirtualDom (line 388, column 6 - line 397, column 51): " + [ v.constructor.name ]);
      });
  };
  var vDomDiff = Data_Diff.diff(Data_Diff["$_DiffableList_2"])(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect)))(function (v) {
      if (v instanceof Data_Diff.Left) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(removeVNode(v.value0))(function () {
              return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(Data_Maybe.Nothing.value);
          });
      };
      if (v instanceof Data_Diff.Right) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(addNode(v.value0))(function (singleNode) {
              return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(new Data_Maybe.Just(singleNode));
          });
      };
      if (v instanceof Data_Diff.Both) {
      ...
      throw new Error("Failed pattern match at VirtualDom (line 207, column 7 - line 215, column 40): " + [ v.constructor.name ]);
  });
  var keyedDiffReplace = function (vnode1) {
      return function (v) {
          return function (tail1) {
              return function (tail2) {
                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(diffSingle(vnode1)(v.value1))(function (newVNode) {
                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(keyedDiff(tail1)(tail2))(function (rest) {
  ...
  var keyedDiffRemove = function (removeMe) {
      return function (oldVNode) {
          return function (v) {
              return function (tail1) {
                  return function (tail2) {
                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(diffSingle(oldVNode)(v.value1))(function (newVNodeNoded) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(removeVNode(removeMe))(function () {
                              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(keyedDiff(tail1)(tail2))(function (rest) {
  ...
  var keyedDiffInsertBefore = function (v) {
      return function (newVNode1$prime) {
          return function (v1) {
              return function (tail1) {
                  return function (tail2) {
                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(diffSingle(v.value1)(newVNode1$prime))(function (newVNode1) {
                          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))((function () {
                              ...
                              if (v2 instanceof Data_Maybe.Nothing) {
                                  return noNodeError(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Writer_Trans.monadEffectWriter(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect_Class.monadEffectEffect)));
                              };
                              throw new Error("Failed pattern match at VirtualDom (line 303, column 16 - line 305, column 27): " + [ v2.constructor.name ]);
                          })())(function (newVNode2) {
                              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(keyedDiff(tail1)(tail2))(function (rest) {
  ...
  var keyedDiff = function (v) {
      return function (v1) {
          if (v instanceof Data_List_Types.Cons && v1 instanceof Data_List_Types.Cons) {
              var $169 = v.value0.value0 === v1.value0.value0;
              if ($169) {
              ...
              if (v.value1 instanceof Data_List_Types.Cons && v1.value1 instanceof Data_List_Types.Cons) {
                  var $172 = v.value0.value0 === Data_Tuple.fst(v1.value1.value0);
                  if ($172) {
                      var $173 = v1.value0.value0 === Data_Tuple.fst(v.value1.value0);
                      if ($173) {
                          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(diffSingle(Data_Tuple.snd(v.value1.value0))(v1.value0.value1))(function (newKey1VNode) {
                              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(diffSingle(v.value0.value1)(Data_Tuple.snd(v1.value1.value0)))(function (newKey2VNode) {
                                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Data_Maybe.fromMaybe(noNodeError(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Writer_Trans.monadEffectWriter(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect_Class.monadEffectEffect))))(Control_Bind.bind(Data_Maybe.bindMaybe)(getNode(newKey1VNode))(function (node1) {
                                      ...
                                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(keyedDiff(v.value1.value1)(v1.value1.value1))(function (rest) {
                  ...
                  var $174 = v1.value0.value0 === Data_Tuple.fst(v.value1.value0);
                  if ($174) {
              ...
              if (v.value1 instanceof Data_List_Types.Cons && v1.value1 instanceof Data_List_Types.Nil) {
                  var $179 = v1.value0.value0 === Data_Tuple.fst(v.value1.value0);
                  if ($179) {
                      return keyedDiffRemove(v.value0.value1)(Data_Tuple.snd(v.value1.value0))(v1.value0)(v.value1.value1)(v1.value1);
                  };
                  return keyedDiffReplace(v.value0.value1)(v1.value0)(v.value1)(v1.value1);
              ...
              if (v.value1 instanceof Data_List_Types.Nil && v1.value1 instanceof Data_List_Types.Cons) {
                  var $182 = v.value0.value0 === Data_Tuple.fst(v1.value1.value0);
                  if ($182) {
                      return keyedDiffInsertBefore(v.value0)(Data_Tuple.snd(v1.value1.value0))(v1.value0)(v.value1)(v1.value1.value1);
                  };
                  return keyedDiffReplace(v.value0.value1)(v1.value0)(v.value1)(v1.value1);
              ...
              throw new Error("Failed pattern match at VirtualDom (line 232, column 12 - line 261, column 62): " + [ v.value1.constructor.name, v1.value1.constructor.name ]);
          };
          if (v1 instanceof Data_List_Types.Nil) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Data_Foldable.traverse_(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(Data_List_Types.foldableList)(function ($220) {
                  return removeVNode(Data_Tuple.snd($220));
              })(v))(function () {
                  return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(Data_Monoid.mempty(Data_List_Types.monoidList));
              });
          };
          if (v instanceof Data_List_Types.Nil) {
              return Data_Traversable.traverse(Data_List_Types.traversableList)(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(addKeyedNode)(v1);
          };
          throw new Error("Failed pattern match at VirtualDom (line 223, column 13 - line 265, column 46): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var diffSingle = function (svn1) {
      return function (svn2) {
          var replace = function (v) {
              var v1 = getNode(svn1);
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(replaceNode(v1.value0)(svn2))(function (svn) {
                      return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(svn);
                  });
              };
              if (v1 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(svn2);
              };
              throw new Error("Failed pattern match at VirtualDom (line 317, column 7 - line 322, column 29): " + [ v1.constructor.name ]);
          };
          if (svn1 instanceof VElement && svn2 instanceof VElement) {
              var $197 = svn1.value0.tag === svn2.value0.tag;
              if ($197) {
                  if (svn1.value0.noDiff) {
                      return replace(Data_Unit.unit);
                  };
                  var result = Control_Bind.bind(Data_Maybe.bindMaybe)(svn1.value0.node)(function (elem) {
                      return new Data_Maybe.Just(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(addCss(svn2.value0.css))(function () {
                          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect))(diffAttributes(elem)(svn1.value0.attributes)(svn2.value0.attributes)))(function (attributes) {
                              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Control_Monad_Reader_Class.local(Control_Monad_Reader_Trans.monadReaderReaderT(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect)))(changeParent(elem))(vDomDiff(svn1.value0.children)(svn2.value0.children)))(function (children) {
                                  return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(new VElement({
                                      tag: svn1.value0.tag,
                  ...
                  throw new Error("Failed pattern match at VirtualDom (line 344, column 11 - line 346, column 36): " + [ result.constructor.name ]);
              };
              return replace(Data_Unit.unit);
          };
          if (svn1 instanceof KeyedElement && svn2 instanceof KeyedElement) {
              var $203 = svn1.value0.tag === svn2.value0.tag;
              if ($203) {
                  var result = Control_Bind.bind(Data_Maybe.bindMaybe)(svn1.value0.node)(function (elem) {
                      return new Data_Maybe.Just(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(addCss(svn2.value0.css))(function () {
                          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect))(diffAttributes(elem)(svn1.value0.attributes)(svn2.value0.attributes)))(function (attributes) {
                              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Control_Monad_Reader_Class.local(Control_Monad_Reader_Trans.monadReaderReaderT(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect)))(changeParent(elem))(keyedDiff(svn1.value0.children)(svn2.value0.children)))(function (children) {
                                  return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(new KeyedElement({
                                      tag: svn1.value0.tag,
                                      styles: svn1.value0.styles,
                                      css: svn1.value0.css,
                                      attributes: attributes,
                  ...
                  throw new Error("Failed pattern match at VirtualDom (line 366, column 9 - line 368, column 34): " + [ result.constructor.name ]);
              };
              return replace(Data_Unit.unit);
          };
          if (svn1 instanceof VText && svn2 instanceof VText) {
              var $208 = svn1.value0.text === svn2.value0.text;
              if ($208) {
                  return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(svn1);
              };
              return replace(Data_Unit.unit);
          };
          return replace(Data_Unit.unit);
...
(function($PS) {
  ...
  var $foreign = $PS["WHATWG.DOM.Event"];
  var WHATWG_Internal = $PS["WHATWG.Internal"];                
...
(function($PS) {
  ...
  var WHATWG_Internal = $PS["WHATWG.Internal"];
  var value = (function () {
      var $22 = VirtualDom.Prop.create("value");
      return function ($23) {
          return Data_Batched.Single.create($22(Data_JSValue.toJSValue($23)));
      };
  })();
  var title = (function () {
      var $30 = VirtualDom.Attr.create("title");
      return function ($31) {
          return Data_Batched.Single.create($30($31));
      };
  })();
  var property = PointFree.compose2(Data_Batched.Single.create)(VirtualDom.Prop.create);
  var onInputRefEq = function (toMsg) {
      return function (event) {
          return Data_Functor.mapFlipped(Effect.functorEffect)(WHATWG_Internal.unsafeGet("value")(WHATWG_DOM_Event.unsafeTarget()(event)))((function () {
              var $100 = Producer.produce(Producer.produceProducer)(toMsg);
              return function ($101) {
  ...
  var name = (function () {
      var $108 = VirtualDom.Attr.create("name");
      return function ($109) {
          return Data_Batched.Single.create($108($109));
      };
  })();
  var makeListener = function (toEventCallback) {
  ...
  var onInput = function (dictProduce) {
      var $128 = on(Producer.produceProducer)("input");
      var $129 = Producer.producer(Producer.eqProducer)(onInputRefEq);
      var $130 = Producer.lift(dictProduce);
      return function ($131) {
  ...
  var id = (function () {
      var $176 = VirtualDom.Attr.create("id");
      return function ($177) {
          return Data_Batched.Single.create($176($177));
      };
  })();
  var alwaysSet = Data_Batched.mapBoth(VirtualDom.AlwaysSet.create);
...
(function($PS) {
  ...
  exports["$_SemigroupStringOp_30"] = $dollar_SemigroupStringOp_30;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  ...
  var toUnit = function (suffix) {
      return function (n) {
          return Data_Show.show(Data_Show.showNumber)(n) + suffix;
      };
  };                  
  var px = toUnit("px");
  var prepend = function (str) {
      return Data_Semigroup.append(VirtualDom_Css["$_SemigroupStringOp_30"])(new VirtualDom_Css.Const(str))(VirtualDom_Css.Id.value);
  };                    
  var mapSelector = function (op) {
      return function (styles) {
          return Data_Functor.mapFlipped(Data_Batched["$_FunctorBatched_4"](Data_Identity.functorIdentity))(new Data_Batched.Batch(styles))(function (v) {
              return new VirtualDom_Css.Declaration(new VirtualDom_Css.Compose(op, v.value0), v.value1, v.value2);
          });
      };
  };                      
  var declaration = PointFree.compose2(Control_Applicative.pure(Data_Batched["$_ApplicativeBatched_6"](Data_Identity.applicativeIdentity)))(VirtualDom_Css.Declaration.create(VirtualDom_Css.Id.value));
  ...
  var marginTop = declaration("margin-top");    
  var opacity = declaration("opacity");
  var outline = declaration("outline");           
  var overflow = declaration("overflow");         
  var overflowX = declaration("overflow-x");                     
  var padding = declaration("padding");                      
  var paddingBottom = declaration("padding-bottom");
  var paddingTop = declaration("padding-top");      
  var position = declaration("position"); 
  var top = declaration("top");
  var transform = declaration("transform");   
  var variable = (function () {
      var $567 = Data_Semigroup.append(Data_Semigroup.semigroupString)("--");
      return function ($568) {
          return declaration($567($568));
      };
  })();                              
  var whiteSpace = declaration("white-space");
  var width = declaration("width");             
  var color = declaration("color");                    
  var borderTop = declaration("border-top");
  var borderRadius = declaration("border-radius");
  ...
  var borderBottom = declaration("border-bottom");
  var border = declaration("border");                             
  var background = declaration("background");
  var append = function (str) {
      return Data_Semigroup.append(VirtualDom_Css["$_SemigroupStringOp_30"])(VirtualDom_Css.Id.value)(new VirtualDom_Css.Const(str));
  };
...
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  $PS["Css.Functions"] = $PS["Css.Functions"] || {};
  var exports = $PS["Css.Functions"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Monoid = $PS["Data.Monoid"];            
  var $$var = function (name) {
      return "var(--" + (name + ")");
  };                                                                   
  var functionJ = function (name) {
      return function (args) {
          return name + ("(" + (Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(", ")(args) + ")"));
      };
  };
  var linearGradient = functionJ("linear-gradient");
  var function3 = function (name) {
      return function (a) {
          return function (b) {
              return function (c) {
                  return functionJ(name)([ a, b, c ]);
              };
          };
      };
  };
  var hsl = function3("hsl");
  var $$function = function (name) {
      return function (a) {
          return functionJ(name)([ a ]);
      };
  };                                      
  var translateX = $$function("translateX");
...
(function($PS) {
  ...
  var rule = function (selector) {
      return function (styles) {
          return Control_Applicative.pure(Data_Batched["$_ApplicativeBatched_6"](Data_Identity.applicativeIdentity))(new Rule({
              selector: selector,
  ...
  var imports = (function () {
      var $21 = Control_Applicative.pure(Data_Batched["$_ApplicativeBatched_6"](Data_Identity.applicativeIdentity));
      return function ($22) {
          return $21(Import.create($22));
      };
  })();                       
  var button = rule("button");
  var body = rule("body");
  exports["style"] = style;
  exports["rule"] = rule;
  exports["body"] = body;
  ...
  var hmapWithIndexRecord = function (dictRowToList) {
      return function (dictMapRecordWithIndex) {
          return new HMapWithIndex((function () {
              var $71 = mapRecordWithIndexBuilder(dictMapRecordWithIndex)(Type_Proxy["Proxy"].value);
              return function ($72) {
...
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  $PS["Css.Variables.Internal"] = $PS["Css.Variables.Internal"] || {};
  var exports = $PS["Css.Variables.Internal"];
  var Data_Symbol = $PS["Data.Symbol"];
  ...
  var MapIndex = (function () {
      ...
      MapIndex.create = function (value0) {
          return new MapIndex(value0);
      };
      return MapIndex;
  })();
  var $dollar_MappingWithIndexMapIndexP_3 = function (dictIsSymbol) {
      return new Heterogeneous_Mapping.MappingWithIndex(function (v) {
          return function (v1) {
              return function (v2) {
                  return v.value0(Data_Symbol.reflectSymbol(dictIsSymbol)(Type_Proxy["Proxy"].value));
              };
          };
      });
  };
...
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  $PS["Css.Variables"] = $PS["Css.Variables"] || {};
  var exports = $PS["Css.Variables"];
  var Css = $PS["Css"];
  var Css_Functions = $PS["Css.Functions"];
  var Css_Variables_Internal = $PS["Css.Variables.Internal"];
  var Data_Batched = $PS["Data.Batched"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Tuple = $PS["Data.Tuple"];
  var Data_Unfoldable = $PS["Data.Unfoldable"];
          ...
          var handleSubs = function (model) {
              return function (domSubs) {
                  return function __do() {
                      ...
                      var newActiveSubs = Sub.something(activeSubs)(Data_Semigroup.append(Data_Batched["$_SemigroupBatched_7"])(domSubs)(init.subscriptions(model)))(sendMsg)();
                      return Effect_Ref.write(newActiveSubs)(refs.activeSubs)();
                  };
              };
          };
          var newActiveSubs = Sub.something([  ])(Data_Semigroup.append(Data_Batched["$_SemigroupBatched_7"])(v1.value1)(init.subscriptions(v.value0)))(sendMsg)();
...
(function($PS) {
  ...
  var Css_Variables = $PS["Css.Variables"];
  var Css_Variables_Internal = $PS["Css.Variables.Internal"];
  var Data_Show = $PS["Data.Show"];
  var Data_Symbol = $PS["Data.Symbol"];
  var Heterogeneous_Mapping = $PS["Heterogeneous.Mapping"];
...
(function($PS) {
  ...
  var VirtualDom = $PS["VirtualDom"];
  var VirtualDom_Css = $PS["VirtualDom.Css"];                
  var text = function ($14) {
      return Data_Batched.Single.create(VirtualDom.text($14));
  };
          ...
          return function (attributes) {
              return function (children) {
                  ...
                  return Data_Batched.Single.create(VirtualDom.VElement.create((function (r) {
                      ...
                      throw new Error("Failed pattern match at Html (line 342, column 15 - line 348, column 23): " + [ mstyles.constructor.name ]);
                  })({
                      tag: tag,
                      styles: styles$prime,
                      css: Data_Maybe.Nothing.value,
  ...
  var inputS = PointFree.applyThird(elementS("input"))([  ]);
...
(function($PS) {
  "use strict";
  $PS["InputBox"] = $PS["InputBox"] || {};
  var exports = $PS["InputBox"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_String_CodePoints = $PS["Data.String.CodePoints"];
  var Data_Tuple = $PS["Data.Tuple"];                
  var InputBox = function (x) {
      return x;
  };
  var undo = function (v) {
      return InputBox({
  ...
  var setCursor = (function () {
      var $27 = Control_Bind.join(Control_Bind.bindFn)(Data_Tuple.Tuple.create);
      return function ($28) {
          return setSelectionRange($27($28));
      };
  })();
  ...
  var setContentAndCursor = function (str) {
      var $29 = setCursor(Data_String_CodePoints.length(str));
      var $30 = setContent(str);
      return function ($31) {
          return $29($30($31));
      };
  };
  var selectionStart = function (v) {
      return Data_Tuple.fst(v.selectionRange);
  };
  var selectionEnd = function (v) {
      return Data_Tuple.snd(v.selectionRange);
  };
  var prevContent = function (v) {
      return v.prevContent;
  };
  var height = function (v) {
      return v.height;
  };
  var defaultHeight = 30.0;
  ...
  var reset = function (v) {
      return {
          ...
          selectionRange: new Data_Tuple.Tuple(0, 0)
      };
  };
  var $$default = {
      content: "",
  ...
  exports["setContentAndCursor"] = setContentAndCursor;
...
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  $PS["ModelMsg"] = $PS["ModelMsg"] || {};
  var exports = $PS["ModelMsg"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var UpdateInputBox = (function () {
      function UpdateInputBox(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateInputBox.create = function (value0) {
          return function (value1) {
              return new UpdateInputBox(value0, value1);
          };
      };
      return UpdateInputBox;
  })();
  ...
  var SelectThread = (function () {
      function SelectThread(value0) {
          this.value0 = value0;
      };
      SelectThread.create = function (value0) {
          return new SelectThread(value0);
      };
      return SelectThread;
  })();
  ...
  var SelectSibling = (function () {
      function SelectSibling(value0) {
          this.value0 = value0;
      };
      SelectSibling.create = function (value0) {
          return new SelectSibling(value0);
      };
      return SelectSibling;
  })();
  var Undo = (function () {
      function Undo() {
  ...
  var UpdateNotificationSound = (function () {
      function UpdateNotificationSound(value0) {
          this.value0 = value0;
      };
      UpdateNotificationSound.create = function (value0) {
          return new UpdateNotificationSound(value0);
      };
      return UpdateNotificationSound;
  })();
  ...
  var $dollar_EqInputAction_4 = new Data_Eq.Eq(function (x) {
      return function (y) {
          return true;
      };
  });
  var $dollar_EqMsg_5 = new Data_Eq.Eq(function (v) {
      return function (v1) {
          if (v instanceof UpdateInputBox && v1 instanceof UpdateInputBox) {
              return Data_Eq.eq(Data_Maybe.eqMaybe($dollar_EqInputAction_4))(v.value0)(v1.value0) && v.value1 === v1.value1;
          };
          ...
          if (v instanceof SelectThread && v1 instanceof SelectThread) {
              return Data_Eq.eq(Y_Shared_Id.eqId)(v.value0)(v1.value0);
          };
  ...
  exports["UpdateInputBox"] = UpdateInputBox;
  ...
  exports["SelectSibling"] = SelectSibling;
  exports["Undo"] = Undo;
  exports["UpdateNotificationSound"] = UpdateNotificationSound;
  exports["Focused"] = Focused;
  exports["$_EqMsg_5"] = $dollar_EqMsg_5;
})(PS);
(function(exports) {
...
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  $PS["WHATWG.HTML.HTMLTextAreaElement"] = $PS["WHATWG.HTML.HTMLTextAreaElement"] || {};
  var exports = $PS["WHATWG.HTML.HTMLTextAreaElement"];
  var WHATWG_Internal = $PS["WHATWG.Internal"];                
  var value = WHATWG_Internal.unsafeGet("value");                 
  var selectionStart = WHATWG_Internal.unsafeGet("selectionStart");
  var selectionEnd = WHATWG_Internal.unsafeGet("selectionEnd");
  exports["value"] = value;
  exports["selectionStart"] = selectionStart;
  exports["selectionEnd"] = selectionEnd;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  $PS["WHATWG.HTML.KeyboardEvent"] = $PS["WHATWG.HTML.KeyboardEvent"] || {};
  var exports = $PS["WHATWG.HTML.KeyboardEvent"];
  var WHATWG_Internal = $PS["WHATWG.Internal"];            
  var metaKey = WHATWG_Internal.unsafeGetPure("metaKey");
  var key = WHATWG_Internal.unsafeGetPure("key");
  var ctrlKey = WHATWG_Internal.unsafeGetPure("ctrlKey");
...
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  $PS["WHATWG.HTML.Mixin.DocumentOrShadowRoot"] = $PS["WHATWG.HTML.Mixin.DocumentOrShadowRoot"] || {};
  var exports = $PS["WHATWG.HTML.Mixin.DocumentOrShadowRoot"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Nullable = $PS["Data.Nullable"];
  var Effect = $PS["Effect"];
  var WHATWG_Internal = $PS["WHATWG.Internal"];                
  var activeElementNullable = function (dictDocumentOrShadowRoot) {
      return WHATWG_Internal.unsafeGet("activeElement");
  };
  var activeElement = function (dictDocumentOrShadowRoot) {
      var $2 = Data_Functor.map(Effect.functorEffect)(Data_Nullable.toMaybe);
      var $3 = activeElementNullable();
      return function ($4) {
          return $2($3($4));
      };
  };
...
(function($PS) {
  ...
  var Effect_Unsafe = $PS["Effect.Unsafe"];
  var Html = $PS["Html"];
  var InputBox = $PS["InputBox"];
  var ModelMsg = $PS["ModelMsg"];
  var Platform = $PS["Platform"];
  var Producer = $PS["Producer"];
  var RefEq = $PS["RefEq"];
  var WHATWG_DOM_Element = $PS["WHATWG.DOM.Element"];
  ...
  var WHATWG_HTML_Document = $PS["WHATWG.HTML.Document"];
  var WHATWG_HTML_HTMLTextAreaElement = $PS["WHATWG.HTML.HTMLTextAreaElement"];
  var WHATWG_HTML_KeyboardEvent = $PS["WHATWG.HTML.KeyboardEvent"];
  var WHATWG_HTML_Mixin_DocumentOrShadowRoot = $PS["WHATWG.HTML.Mixin.DocumentOrShadowRoot"];
  var WHATWG_HTML_Mixin_HTMLOrSVGElement = $PS["WHATWG.HTML.Mixin.HTMLOrSVGElement"];
  var WHATWG_HTML_Types = $PS["WHATWG.HTML.Types"];
  var WHATWG_HTML_Window = $PS["WHATWG.HTML.Window"];                
  var ref = Effect_Unsafe.unsafePerformEffect(Effect_Ref["new"](InputBox["default"]));
  var id = "input";
  var updateState = function __do() {
      var oldState = Effect_Ref.read(ref)();
      var doc = WHATWG_HTML_Window["document'"]();
      var mtextarea = Data_Functor.mapFlipped(Effect.functorEffect)(WHATWG_DOM_Mixin_NonElementParentNode.getElementById()(id)(doc))(WHATWG_HTML_Types.toMaybeHTMLTextAreaElement())();
      var newState = (function () {
          if (mtextarea instanceof Data_Maybe.Just) {
              var value = WHATWG_HTML_HTMLTextAreaElement.value(mtextarea.value0)();
              var height = Data_Functor.map(Effect.functorEffect)(Data_Int.toNumber)(WHATWG_DOM_Element.scrollHeight()(mtextarea.value0))();
              var selectionStart = WHATWG_HTML_HTMLTextAreaElement.selectionStart(mtextarea.value0)();
              var selectionEnd = WHATWG_HTML_HTMLTextAreaElement.selectionEnd(mtextarea.value0)();
              var newState = InputBox.setSelectionRange(new Data_Tuple.Tuple(selectionStart, selectionEnd))(InputBox.setHeight(height + Design.inputBoxBorderWidth)(InputBox.setContent(value)(oldState)));
              Effect_Ref.write(newState)(ref)();
              return new Data_Maybe.Just(newState);
          };
          if (mtextarea instanceof Data_Maybe.Nothing) {
              return Data_Maybe.Nothing.value;
          };
          throw new Error("Failed pattern match at Input (line 53, column 7 - line 70, column 32): " + [ mtextarea.constructor.name ]);
      })();
      return new Data_Tuple.Tuple(oldState, newState);
  };
          ...
          return function (model) {
              return function (msg) {
                  return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(function __do() {
                      ...
                      return update(addIB(model)(currentInputBox))(msg);
                  });
              };
          };
      };
  };
  var onInput = Attribute.on(Producer.produceab)("input")(function (v) {
      return function __do() {
          var v1 = updateState();
          if (v1.value1 instanceof Data_Maybe.Just) {
              var height = InputBox.height(v1.value1.value0);
              var helper = function (b) {
                  return function (update) {
                      return function (ma) {
                          var helper2 = function (a) {
                              if (b) {
                                  return Data_Maybe.Just.create(update(a));
                              };
                              return ma;
                          };
                          if (ma instanceof Data_Maybe.Just) {
                              return helper2(ma.value0);
                          };
                          if (ma instanceof Data_Maybe.Nothing) {
                              return helper2(new Data_Tuple.Tuple(Data_Maybe.Nothing.value, height));
                          };
                          throw new Error("Failed pattern match at Input (line 122, column 15 - line 124, column 55): " + [ ma.constructor.name ]);
                      };
                  };
              };
              return Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(helper(InputBox.content(v1.value1.value0) === "/edit " && InputBox.content(v1.value0) === "/edit")(function (v2) {
                  return new Data_Tuple.Tuple(new Data_Maybe.Just(ModelMsg.Edit.value), v2.value1);
              })(helper(height !== InputBox.height(v1.value0))(function (v2) {
                  return new Data_Tuple.Tuple(v2.value0, height);
              })(Data_Maybe.Nothing.value)))(Data_Tuple.uncurry(ModelMsg.UpdateInputBox.create));
          };
  ...
  var hitEnter = (function () {
      var $39 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($40) {
          return (function (v) {
              if (v instanceof Data_Maybe.Just) {
                  var $30 = WHATWG_HTML_KeyboardEvent.key(v.value0) === "Enter";
                  if ($30) {
                      return function __do() {
                          ...
                          if (v1 instanceof Data_Maybe.Just) {
                              var $32 = Data_Eq.eq(RefEq.eqRefEq)(new RefEq.RefEq(body))(new RefEq.RefEq(v1.value0));
                              if ($32) {
                                  Control_Bind.bind(Effect.bindEffect)(Data_Functor.map(Effect.functorEffect)(WHATWG_HTML_Types.toMaybeHTMLElement())(WHATWG_DOM_Mixin_NonElementParentNode.getElementById()(id)(document)))(Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(WHATWG_HTML_Mixin_HTMLOrSVGElement.focus()()({})))();
  ...
  var focusInput = Platform.afterRender(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(WHATWG_HTML_Window["document'"])((function () {
      var $41 = Data_Functor.map(Effect.functorEffect)(WHATWG_HTML_Types.toMaybeHTMLElement());
      var $42 = WHATWG_DOM_Mixin_NonElementParentNode.getElementById()(id);
      return function ($43) {
          return $41($42($43));
      };
  ...
  var detectSpecial = Attribute.on(Producer.produceab)("keydown")((function () {
      var $44 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($45) {
          return (function (v) {
              if (v instanceof Data_Maybe.Just) {
                  var $36 = WHATWG_HTML_KeyboardEvent.key(v.value0) === "Enter" && (WHATWG_HTML_KeyboardEvent.ctrlKey(v.value0) || WHATWG_HTML_KeyboardEvent.metaKey(v.value0));
                  if ($36) {
                      return function __do() {
                          WHATWG_DOM_Event.preventDefault()(v.value0)();
                          return new Data_Maybe.Just(ModelMsg.SendMessage.value);
                      };
                  };
                  var $37 = WHATWG_HTML_KeyboardEvent.key(v.value0) === "z" && WHATWG_HTML_KeyboardEvent.ctrlKey(v.value0);
                  if ($37) {
                      return function __do() {
                          WHATWG_DOM_Event.preventDefault()(v.value0)();
                          return new Data_Maybe.Just(ModelMsg.Undo.value);
                      };
                  };
                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value);
              };
  ...
  var html = function (model) {
      return Html.textareaS([ Css.height(Css.px(InputBox.height(model.inputBox))), Css.flex("1"), Css.borderJ([ Css.px(Design.inputBoxBorderWidth), "solid", Design.vars.color ]), Css.padding(".45em"), Design.inputStyles, Css.borderTop("none") ])([ Attribute.id(id), Attribute.alwaysSet(Attribute.value(InputBox.content(model.inputBox))), Attribute.alwaysSet(Attribute.property("selectionStart")(Data_JSValue.toJSValue(InputBox.selectionStart(model.inputBox)))), Attribute.alwaysSet(Attribute.property("selectionEnd")(Data_JSValue.toJSValue(InputBox.selectionEnd(model.inputBox)))), onInput, detectSpecial ])([  ]);
  };
...
(function($PS) {
  ...
  var toTreeMap = function (dictOrd) {
      var $139 = Data_Foldable.foldl(Data_List_Types.foldableList)(function (v) {
          return function (v1) {
      ...
      return function ($140) {
          return TreeMap($139($140));
      };
  };
  var removeLeaf = function (dictOrd) {
      return function (key) {
          return function (v) {
              var v1 = Data_Map_Internal.lookup(dictOrd)(key)(v.leaves);
              if (v1 instanceof Data_Maybe.Just) {
                  var potentialNewLeaves = Data_Map_Internal["delete"](dictOrd)(key)(v.leaves);
                  var newParentData = Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(v1.value0.parent)(function (pid) {
                      var v2 = Data_Map_Internal.lookup(dictOrd)(pid)(v.parents);
                      if (v2 instanceof Data_Maybe.Just && v2.value0 instanceof Data_Either.Right) {
                          var newChildren = Data_Array["delete"](dictOrd.Eq0())(key)(v2.value0.value0.children);
                          return new Data_Tuple.Tuple(Data_Eq.eq(Data_Eq.eqArray(dictOrd.Eq0()))(newChildren)([  ]), new Data_Tuple.Tuple(pid, new Data_Either.Right({
                              children: newChildren,
                              parent: v2.value0.value0.parent,
                              value: v2.value0.value0.value
                          })));
                      };
                      return Effect_Exception_Unsafe.unsafeThrow("removeLeaf");
                  });
                  if (newParentData instanceof Data_Maybe.Just && (newParentData.value0.value0 && newParentData.value0.value1.value1 instanceof Data_Either.Right)) {
                      return {
                          leaves: Data_Map_Internal.insert(dictOrd)(newParentData.value0.value1.value0)(newParentData.value0.value1.value1.value0)(potentialNewLeaves),
                          parents: Data_Map_Internal["delete"](dictOrd)(newParentData.value0.value1.value0)(v.parents)
                      };
                  };
                  if (newParentData instanceof Data_Maybe.Just && !newParentData.value0.value0) {
                      return {
                          leaves: potentialNewLeaves,
                          parents: Data_Map_Internal.insert(dictOrd)(newParentData.value0.value1.value0)(newParentData.value0.value1.value1)(v.parents)
                      };
                  };
                  if (newParentData instanceof Data_Maybe.Nothing) {
                      return {
                          leaves: potentialNewLeaves,
                          parents: v.parents
                      };
                  };
                  return Effect_Exception_Unsafe.unsafeThrow("removeLeaf 2");
              };
              if (v1 instanceof Data_Maybe.Nothing) {
                  return v;
              };
              ...
              return Control_Bind.bind(Data_Either.bindEither)(lookupEither(dictOrd)(key)(tm))(function (v) {
                  if (v.parent instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Functor.mapFlipped(Data_Either.functorEither)(find(v.parent.value0))((function () {
                          var $141 = Data_Array["delete"](dictOrd.Eq0())(key);
                          return function ($142) {
                              return $141((function (v1) {
                                  return v1.children;
                              })($142));
                          };
                      })()))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)((function () {
                          var $143 = Data_Functor.map(Data_Either.functorEither)(function (v1) {
                              return v1.value;
                          });
                          return function ($144) {
                              return $143(find($144));
      ...
      return function (key) {
          return function (tm) {
              return Data_Maybe.maybe(false)(function (v) {
                  return true;
              })(lookup(dictOrd)(key)(tm));
          };
      };
  };
  var removeLeafRecursive = function ($copy_dictOrd) {
      return function ($copy_shouldRemove) {
          return function ($copy_key) {
              return function ($copy_tm) {
                  var $tco_var_dictOrd = $copy_dictOrd;
                  var $tco_var_shouldRemove = $copy_shouldRemove;
                  var $tco_var_key = $copy_key;
                  var $tco_done = false;
                  var $tco_result;
                  function $tco_loop(dictOrd, shouldRemove, key, tm) {
                      var v = lookup(dictOrd)(key)(tm);
                      if (v instanceof Data_Maybe.Just) {
                          var $109 = Data_Eq.eq(Data_Eq.eqArray(dictOrd.Eq0()))(v.value0.children)([  ]) && shouldRemove(v.value0);
                          if ($109) {
                              var newTm = removeLeaf(dictOrd)(key)(tm);
                              if (v.value0.parent instanceof Data_Maybe.Just) {
                                  $tco_var_dictOrd = dictOrd;
                                  $tco_var_shouldRemove = shouldRemove;
                                  $tco_var_key = v.value0.parent.value0;
                                  $copy_tm = newTm;
                                  return;
                              };
                  ...
                  while (!$tco_done) {
                      $tco_result = $tco_loop($tco_var_dictOrd, $tco_var_shouldRemove, $tco_var_key, $copy_tm);
                  };
                  return $tco_result;
              };
          };
  ...
  var isLeaf = function (dictOrd) {
      return function (key) {
          return function (tm) {
              return Data_Maybe.maybe(false)(function ($145) {
      ...
      return function (key) {
          return function (oldTM) {
              return function (newTM) {
                  var $130 = member(dictOrd)(key)(newTM);
                  if ($130) {
                      return findLeaf(dictOrd)(key)(newTM);
                  };
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(lookup(dictOrd)(key)(oldTM))(function (v) {
                      return v.parent;
                  }))(PointFree.applySecond(PointFree.applySecond(findNewLeaf(dictOrd))(oldTM))(newTM));
              };
          };
      };
  };
      ...
      return function (key) {
          return function (f) {
              return function (v) {
                  ...
                  if (v1 instanceof Data_Maybe.Just) {
                      return TreeMap({
                          leaves: Data_Map_Internal.insert(dictOrd)(key)(f(v1.value0))(v.leaves),
                          parents: v.parents
                      });
                  };
                  if (v1 instanceof Data_Maybe.Nothing) {
                      var v2 = Data_Map_Internal.lookup(dictOrd)(key)(v.parents);
                      if (v2 instanceof Data_Maybe.Just && v2.value0 instanceof Data_Either.Right) {
                          return TreeMap({
                              leaves: v.leaves,
                              parents: Data_Map_Internal.insert(dictOrd)(key)(new Data_Either.Right(f(v2.value0.value0)))(v.parents)
                          });
                      };
                      return v;
                  };
  ...
  exports["findNewLeaf"] = findNewLeaf;
  exports["getThread"] = getThread;
  exports["isLeaf"] = isLeaf;
  exports["leaves"] = leaves;
  exports["lookup"] = lookup;
  exports["member"] = member;
  exports["removeLeafRecursive"] = removeLeafRecursive;
...
(function($PS) {
  ...
  var EventPayload_MessageEdit = (function () {
      function EventPayload_MessageEdit(value0) {
          this.value0 = value0;
      };
      EventPayload_MessageEdit.create = function (value0) {
          return new EventPayload_MessageEdit(value0);
      };
      return EventPayload_MessageEdit;
  })();
  var EventPayload_MessageDelete = (function () {
      function EventPayload_MessageDelete(value0) {
          this.value0 = value0;
      };
      EventPayload_MessageDelete.create = function (value0) {
          return new EventPayload_MessageDelete(value0);
      };
      return EventPayload_MessageDelete;
  })();
  ...
  var genericEventPayload = new Data_Generic_Rep.Generic(function (x) {
      ...
      if (x instanceof EventPayload_MessageEdit) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(x.value0)));
      };
      if (x instanceof EventPayload_MessageDelete) {
      ...
      throw new Error("Failed pattern match at Y.Shared.Event (line 74, column 1 - line 74, column 62): " + [ x.constructor.name ]);
  }, function (x) {
      ...
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0 instanceof Data_Generic_Rep.Inl)) {
          return new EventPayload_MessageEdit(x.value0.value0.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0.value0 instanceof Data_Generic_Rep.Inl))) {
          return new EventPayload_MessageDelete(x.value0.value0.value0.value0);
      };
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && (x.value0.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0.value0 instanceof Data_Generic_Rep.Inr))) {
          return new EventPayload_SetReadState(x.value0.value0.value0.value0);
      };
      throw new Error("Failed pattern match at Y.Shared.Event (line 74, column 1 - line 74, column 62): " + [ x.constructor.name ]);
  });
  ...
  var decodeJsonEventPayload = new Data_Argonaut_Decode_Class.DecodeJson(Data_Argonaut_Decode_Generic.genericDecodeJson(genericEventPayload)(Data_Argonaut_Decode_Generic.decodeRepSum(Data_Argonaut_Decode_Generic.decodeRepConstructorArg(new Data_Symbol.IsSymbol(function () {
      ...
      return "EventPayload_MessageSend";
  }))(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Y_Shared_Id.decodeJsonId))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Y_Shared_Id.decodeJsonId))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Y_Shared_Id.decodeJsonId))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonBoolean))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeSet(Y_Shared_Id.ordId)(Y_Shared_Id.decodeJsonId)))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Y_Shared_Id.decodeJsonId))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Y_Shared_Util_Instant.decodeJsonInstant))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "timeSent";
  }))()())(new Data_Symbol.IsSymbol(function () {
      return "id";
  }))()())(new Data_Symbol.IsSymbol(function () {
      ...
      return "EventPayload_MessageEdit";
  }))(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Y_Shared_Id.decodeJsonId))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Y_Shared_Id.decodeJsonId))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Y_Shared_Id.decodeJsonId))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "messageId";
  }))()())(new Data_Symbol.IsSymbol(function () {
      return "convoId";
  }))()())(new Data_Symbol.IsSymbol(function () {
      ...
      return "EventPayload_MessageDelete";
  }))(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Y_Shared_Id.decodeJsonId))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Y_Shared_Id.decodeJsonId))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Y_Shared_Id.decodeJsonId))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
      return "userId";
  }))()())(new Data_Symbol.IsSymbol(function () {
      return "messageId";
  }))()())(new Data_Symbol.IsSymbol(function () {
  ...
  exports["EventPayload_MessageEdit"] = EventPayload_MessageEdit;
  exports["EventPayload_MessageDelete"] = EventPayload_MessageDelete;
  exports["EventPayload_SetReadState"] = EventPayload_SetReadState;
...
(function($PS) {
  ...
  var splitEvents = Data_Foldable.foldr(Data_Foldable.foldableArray)(function (v) {
      return function (acc) {
          if (v.payload instanceof Y_Shared_Event.EventPayload_SetName) {
              return {
                  setName: new Data_List_Types.Cons(v.payload.value0, acc.setName),
          ...
          if (v.payload instanceof Y_Shared_Event.EventPayload_MessageSend) {
              return {
                  messageSend: new Data_List_Types.Cons(v.payload.value0, acc.messageSend),
                  setName: acc.setName,
                  messageEdit: acc.messageEdit,
                  messageDelete: acc.messageDelete,
                  setReadState: acc.setReadState
          ...
          if (v.payload instanceof Y_Shared_Event.EventPayload_MessageEdit) {
              return {
                  messageEdit: new Data_List_Types.Cons(v.payload.value0, acc.messageEdit),
                  messageSend: acc.messageSend,
                  setName: acc.setName,
                  messageDelete: acc.messageDelete,
                  setReadState: acc.setReadState
          ...
          if (v.payload instanceof Y_Shared_Event.EventPayload_MessageDelete) {
              return {
                  messageDelete: new Data_List_Types.Cons(v.payload.value0, acc.messageDelete),
                  messageEdit: acc.messageEdit,
                  messageSend: acc.messageSend,
                  setName: acc.setName,
                  setReadState: acc.setReadState
          ...
          if (v.payload instanceof Y_Shared_Event.EventPayload_SetReadState) {
              return {
                  setReadState: new Data_List_Types.Cons(v.payload.value0, acc.setReadState),
                  messageDelete: acc.messageDelete,
                  messageEdit: acc.messageEdit,
                  messageSend: acc.messageSend,
                  setName: acc.setName
          ...
          throw new Error("Failed pattern match at Main (line 557, column 8 - line 571, column 59): " + [ v.payload.constructor.name ]);
      };
  })(Data_Monoid.mempty(Data_Monoid.monoidRecord()(Data_Monoid.monoidRecordCons(new Data_Symbol.IsSymbol(function () {
  ...
  var pushReadEvent = function (v) {
      return function (mid) {
          var $88 = Data_Set.member(Data_Tuple.ordTuple(Y_Shared_Id.ordId)(Y_Shared_Id.ordId))(new Data_Tuple.Tuple(v.userId, mid))(v.events.folded.read);
          if ($88) {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(pushEvent(v)(function (v1) {
              return new Y_Shared_Event.EventPayload_SetReadState({
                  convoId: v.convoId,
                  userId: v.userId,
                  messageId: mid,
                  readState: true
              ...
              return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                  events: {
                      folded: {
                          read: Data_Set.insert(Data_Tuple.ordTuple(Y_Shared_Id.ordId)(Y_Shared_Id.ordId))(new Data_Tuple.Tuple(v.userId, mid))(v.events.folded.read),
  ...
  var onNotSelectingClickRE = function (msg) {
      return function (v) {
          return function __do() {
              var selecting = $foreign.isSelecting();
              if (selecting) {
                  return Data_Maybe.Nothing.value;
              };
              return new Data_Maybe.Just(msg);
          };
      };
  };
  var onNotSelectingClick = (function () {
      var $203 = Attribute.on(Producer.produceProducer)("click");
      var $204 = Producer.producer(ModelMsg["$_EqMsg_5"])(onNotSelectingClickRE);
      return function ($205) {
          return $203($204($205));
      };
  })();
  var threadBar = function (model) {
      ...
      return Platform.batch([ Html.divS([ Css.margin("5px") ])([  ])([ Html.button([ Attribute.onClick(Producer.producea(ModelMsg["$_EqMsg_5"]))(ModelMsg.NewThread.value) ])([ Html.text("New Thread") ]) ]), Html.divS([ Css.overflow("auto"), Css.borderJ([ Design.vars.borderWidth1, "solid" ]) ])([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(leaves)(function (mid) {
          return (function (v) {
              if (v instanceof Data_Maybe.Just) {
                  ...
                  return Html.divS([ (function () {
                      var $103 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.thread)(new Data_Maybe.Just(mid));
                      if ($103) {
                          return Css.background(Design.vars.accent1);
                      };
                      return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_8"]);
                  })(), Design.following([ Css.borderTop("1px solid") ]), Css.padding(".3em"), Css.whiteSpace("pre-wrap"), Css.overflow("auto") ])([ onNotSelectingClick(new ModelMsg.SelectThread(mid)) ])([ Html.spanS([ (function () {
                      var $104 = Data_Eq.eq(Y_Shared_Id.eqId)(v.value0.value.authorId)(model.userId) || isRead;
                      if ($104) {
                          return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_8"]);
                      };
                      return Css.color("#ff4040");
                  })() ])([  ])([ Html.text(v.value0.value.content) ]) ]);
              };
              if (v instanceof Data_Maybe.Nothing) {
                  return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_8"]);
              };
  ...
  var getParent = function (v) {
      return function (tm) {
          return Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(v.id)(tm))(function (v1) {
              return v1.parent;
          }))(PointFree.applySecond(TreeMap.lookup(Y_Shared_Id.ordId))(tm)))(function (v1) {
              return v1.value;
          });
      };
  };
  var getName = function (id) {
      return function (names) {
          return Data_Maybe.fromMaybe("<anonymous>")(Data_Map_Internal.lookup(Y_Shared_Id.ordId)(id)(names));
      };
  };
  var getItem = $foreign.getItemImpl(Data_Maybe.Nothing.value)(Data_Maybe.Just.create);
  var formatTimeDiff = function (iOld) {
      return function (iNew) {
          var show$prime = function (time) {
              return function (label) {
                  return Data_Show.show(Data_Show.showInt)(Data_Int.round(time)) + label;
              };
          };
          var seconds = (Y_Shared_Util_Instant.asMilliseconds(iNew) - Y_Shared_Util_Instant.asMilliseconds(iOld)) / 1000.0;
          var $116 = Data_Int.round(seconds) < 120;
          if ($116) {
              return show$prime(seconds)("s");
          };
          var minutes = seconds / 60.0;
          var $117 = Data_Int.round(minutes) < 120;
          if ($117) {
  ...
  var threadView = function (model) {
      ...
      var messageList = (function () {
          var $206 = Data_Functor.map(Data_Functor.functorArray)(function (v) {
              var createMessage = function (isSibling) {
                  return function (styles) {
                      return function (mes) {
                          return Html.divS([ Design.following([ Css.borderBottom("1px solid") ]), Css.position("relative"), Css.padding("3px .25em 6px .25em"), styles ])([ onNotSelectingClick((function () {
                              if (isSibling) {
                                  return ModelMsg.SelectSibling.create;
                              };
                              return ModelMsg.SelectMessageParent.create;
                          })()(mes.id)) ])([ (function () {
                              var $122 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.messageParent)(new Data_Maybe.Just(mes.id));
                              if ($122) {
                              ...
                              return Html.divS([ Css.font("0.72em sans-serif"), Css.opacity("0.6"), Css.marginBottom("0.7em") ])([  ])([ Html.text(getName(mes.authorId)(model.events.folded.names)), (function (v1) {
                                  if (v1 instanceof Data_Maybe.Just) {
                                      return Html.spanS([ Css.marginLeft("12px") ])([ Attribute.title($foreign.dateString(Y_Shared_Util_Instant.asMilliseconds(mes.timeSent))) ])([ Html.text(v1.value0) ]);
                                  };
                                  if (v1 instanceof Data_Maybe.Nothing) {
                                      return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_8"]);
                                  };
          ...
          var $207 = Data_Array.fromFoldable(Data_List_Types.foldableNonEmptyList);
          return function ($208) {
      ...
      var messageInput = Html.divS([ Css.display("flex"), Css.width(Css_Functions.calc(Css_Functions.add("100%")(Design.vars.borderWidth1))) ])([  ])([ Input.html(model), Html.button([ Attribute.onClick(Producer.producea(ModelMsg["$_EqMsg_5"]))(ModelMsg.SendMessage.value) ])([ Html.text("Send") ]) ]);
      return Html.divS([ Design.panel, Css.transform(Css_Functions.translateX(Css_Functions.calc(Css_Functions.sub("0px")(Design.vars.borderWidth1)))) ])([  ])([ Data_Maybe.maybe(Data_Monoid.mempty(Data_Batched["$_MonoidBatched_8"]))(messageList)(mthread), messageInput ]);
  };
  var view = function (model) {
      return {
          head: [ Html.title("\u2144" + (function () {
              if (model.unread) {
      ...
      return (function (events) {
          return {
              names: Data_Foldable.foldl(Data_List_Types.foldableList)(function (acc) {
                  return function (v) {
                      return Data_Map_Internal.insert(Y_Shared_Id.ordId)(v.userId)(v.name)(acc);
                  };
              })(Data_Map_Internal.empty)(events.setName),
              messages: (function () {
                  var initialTM = TreeMap.toTreeMap(Y_Shared_Id.ordId)(Data_Functor.mapFlipped(Data_List_Types.functorList)(events.messageSend)(function ($211) {
                  ...
                  return PointFree.applySecond(Data_Foldable.foldl(Data_List_Types.foldableList)(function (acc) {
                      return function (v) {
                          return TreeMap.edit(Y_Shared_Id.ordId)(v.messageId)(function (vpc) {
                              return {
                                  value: {
                                      content: v.content,
                      ...
                      return function (v) {
                          return TreeMap.removeLeafRecursive(Y_Shared_Id.ordId)(function ($212) {
                              return (function (v1) {
                                  return v1.deleted;
                              })((function (v1) {
                                  return v1.value;
              ...
              read: Data_Foldable.foldl(Data_List_Types.foldableList)(function (acc) {
                  return function (v) {
                      if (v.readState) {
                          return Data_Set.insert(Data_Tuple.ordTuple(Y_Shared_Id.ordId)(Y_Shared_Id.ordId))(new Data_Tuple.Tuple(v.userId, v.messageId))(acc);
                      };
                      return acc;
                  };
  ...
  var focusHandler = function (v) {
      return Control_Applicative.pure(Effect.applicativeEffect)(new Data_Maybe.Just(ModelMsg.Focused.value));
  };
  var subscriptions = function (model) {
      return Platform.batch([ WebSocketSub.wsToSub(ModelMsg.TransmissionReceived.create)(model.wsClient), Sub.on(Producer.produceab)("keydown")(Input.hitEnter), Sub.on(Producer.produceab)("focus")(focusHandler) ]);
  };
  ...
  var init = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))($foreign.notificationsPermission))(function () {
          return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(function __do() {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Control_Monad_Writer_Class.tell(Control_Monad_Writer_Trans.monadTellWriterT(Platform["$_MonoidCmd_10"])(Effect.monadEffect))(function (msgCallback) {
                      ...
                      return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Data_Functor.mapFlipped(Control_Monad_Writer_Trans.functorWriterT(Effect.functorEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(getItem(audioLSKey)))(Data_Maybe.fromMaybe("")))(function (notificationSound) {
                          return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                              ...
                              thread: Data_Maybe.Nothing.value,
  ...
  var addEvents = function (events) {
      return function (newEvents) {
          ...
          if (oldEnd instanceof Data_Maybe.Just && newHead instanceof Data_Maybe.Just) {
              var $152 = Data_Ord.lessThanOrEq(Y_Shared_Util_Instant.ordInstant)(oldEnd.value0.time)(newHead.value0.time);
              if ($152) {
  ...
  var update = Input.infuse(function (v) {
      return function (v1) {
          return {
              inputBox: v1,
              convoId: v.convoId,
      ...
      var v1 = Debug.log(v);
      return function (v2) {
          if (v2 instanceof ModelMsg.UpdateNotificationSound) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))($foreign.setItem(audioLSKey)(v2.value0)))(function () {
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
          ...
          if (v2 instanceof ModelMsg.Undo) {
              return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                  inputBox: InputBox.undo(v.inputBox),
                  convoId: v.convoId,
                  userId: v.userId,
                  notificationSound: v.notificationSound,
                  unread: v.unread,
          ...
          if (v2 instanceof ModelMsg.Focused) {
              return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                  unread: false,
                  convoId: v.convoId,
                  inputBox: v.inputBox,
          ...
          if (v2 instanceof ModelMsg.SelectSibling) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Input.focusInput)(function () {
                  return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(pushReadEvent(v)(v2.value0))(function (model2) {
                      return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                          messageParent: new Data_Maybe.Just(v2.value0),
                          thread: TreeMap.findLeaf(Y_Shared_Id.ordId)(v2.value0)(v.events.folded.messages),
                          convoId: model2.convoId,
                          events: model2.events,
                          inputBox: model2.inputBox,
          ...
          if (v2 instanceof ModelMsg.UpdateName) {
          ...
          if (v2 instanceof ModelMsg.UpdateNameInput) {
              return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                  nameInput: v2.value0,
                  convoId: v.convoId,
                  events: v.events,
          ...
          if (v2 instanceof ModelMsg.SelectMessageParent) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Input.focusInput)(function () {
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                      messageParent: new Data_Maybe.Just(v2.value0),
                      convoId: v.convoId,
          ...
          if (v2 instanceof ModelMsg.NewThread) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Input.focusInput)(function () {
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                      thread: Data_Maybe.Nothing.value,
                      messageParent: Data_Maybe.Nothing.value,
          ...
          if (v2 instanceof ModelMsg.SelectThread) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Input.focusInput)(function () {
                  return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(pushReadEvent(v)(v2.value0))(function (model2) {
                      return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                          thread: new Data_Maybe.Just(v2.value0),
                          messageParent: new Data_Maybe.Just(v2.value0),
                          convoId: model2.convoId,
                          events: model2.events,
                          inputBox: model2.inputBox,
          ...
          if (v2 instanceof ModelMsg.SendMessage) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Input.focusInput)(function () {
                  var errorMsg = {
                      inputBox: InputBox.setContentAndCursor("You didn't send that message!")(v.inputBox),
                      convoId: v.convoId,
                      userId: v.userId,
                      notificationSound: v.notificationSound,
                      unread: v.unread,
                      ...
                      return Data_Maybe.fromMaybe(Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v))(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(v.events.folded.messages))(function (v3) {
                              return new Data_Maybe.Just((function () {
                                  var $165 = Data_Eq.eq(Y_Shared_Id.eqId)(v3.value.authorId)(v.userId);
                                  if ($165) {
                                  ...
                                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(errorMsg);
                              })());
                          });
                      }));
                  };
                  var $167 = Data_String_Utils.startsWith("/edit ")(content);
                  if ($167) {
                      return Data_Maybe.fromMaybe(Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v))(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(v.events.folded.messages))(function (v3) {
                              return new Data_Maybe.Just((function () {
                                  var $169 = Data_Eq.eq(Y_Shared_Id.eqId)(v3.value.authorId)(v.userId);
                                  if ($169) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(pushEvent(v)(function (v4) {
                                          return new Y_Shared_Event.EventPayload_MessageEdit({
                                              ...
                                              messageId: v3.value.id,
                                              authorId: v.userId,
                                              content: Data_String_CodePoints.drop(6)(content)
                                          });
                                      })))(function () {
                                          return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                                              inputBox: InputBox.reset(v.inputBox),
                                              convoId: v.convoId,
                                              userId: v.userId,
                                              notificationSound: v.notificationSound,
                                              unread: v.unread,
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(pushEvent(v)(function (instant) {
                          return new Y_Shared_Event.EventPayload_MessageSend({
                              ...
                              message: {
                                  ...
                                  content: InputBox.content(v.inputBox)
                              }
                          });
                      })))(function () {
                          return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                              inputBox: InputBox.reset(v.inputBox),
                              messageParent: new Data_Maybe.Just(v3),
                              thread: (function () {
                                  if (v.thread instanceof Data_Maybe.Nothing) {
          ...
          if (v2 instanceof ModelMsg.UpdateInputBox) {
              var model2 = {
                  inputBox: InputBox.setHeight(v2.value1)(v.inputBox),
                  convoId: v.convoId,
                  userId: v.userId,
                  notificationSound: v.notificationSound,
                  unread: v.unread,
                  ...
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(Data_Maybe.fromMaybe(model2)(Control_Bind.bind(Data_Maybe.bindMaybe)(model2.messageParent)(function (mid) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(model2.events.folded.messages))(function (v3) {
                          return new Data_Maybe.Just((function () {
                              ...
                              return {
                                  inputBox: InputBox.setContentAndCursor("/edit " + v3.value.content)(v.inputBox),
                                  convoId: model2.convoId,
                                  userId: model2.userId,
                                  notificationSound: model2.notificationSound,
                                  unread: model2.unread,
              ...
              throw new Error("Failed pattern match at Main (line 275, column 11 - line 296, column 35): " + [ v2.value0.constructor.name ]);
          };
          if (v2 instanceof ModelMsg.TransmissionReceived) {
              if (v2.value0 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))($foreign.hasFocus))(function (focused) {
                      var newEvents = addEvents(v.events.raw)(v2.value0.value0.value0);
                      var folded = foldEvents(newEvents);
                      var newLeaf = PointFree.applySecond(PointFree.applySecond(TreeMap.findNewLeaf(Y_Shared_Id.ordId))(v.events.folded.messages))(folded.messages);
                      var newThread = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(newLeaf)(v.thread);
                      var model2 = {
                          events: {
                              raw: newEvents,
                              folded: folded
                          ...
                          messageParent: (function () {
                              if (v.messageParent instanceof Data_Maybe.Just) {
                                  var $184 = InputBox.content(v.inputBox) === "" && TreeMap.isLeaf(Y_Shared_Id.ordId)(v.messageParent.value0)(v.events.folded.messages);
                                  if ($184) {
                                      return newThread;
                                  };
                                  ...
                                  if (v4 instanceof Data_Maybe.Just && !v4.value0) {
                                      return Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(newLeaf)(v.messageParent);
                                  };
                              ...
                              throw new Error("Failed pattern match at Main (line 334, column 25 - line 345, column 45): " + [ v.messageParent.constructor.name ]);
                          })(),
                          thread: newThread,
                          unread: (function () {
                              if (focused) {
                      ...
                      var firstMessage = Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(Data_List.head((function (v3) {
                          return v3.messageSend;
                      })(splitEvents(v2.value0.value0.value0))))(function (v3) {
                          return v3.message;
                      });
                      return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))((function () {
                          if (newThread instanceof Data_Maybe.Just) {
                              return pushReadEvent(model2)(newThread.value0);
                          };
                          if (newThread instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(model2);
                          };
                          throw new Error("Failed pattern match at Main (line 358, column 17 - line 360, column 41): " + [ newThread.constructor.name ]);
                      })())(function (model3) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))((function () {
                              if (firstMessage instanceof Data_Maybe.Just) {
                                  var $192 = Data_Eq.eq(Y_Shared_Id.eqId)(firstMessage.value0.authorId)(v.userId);
                                  if ($192) {
                                      return Data_Maybe.fromMaybe(Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(Data_Unit.unit))(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                                          return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(model3.events.folded.messages))(function (v3) {
                                              return new Data_Maybe.Just((function () {
                                                  if (v3.parent instanceof Data_Maybe.Just) {
                                                  ...
                                                  throw new Error("Failed pattern match at Main (line 370, column 26 - line 372, column 49): " + [ v3.parent.constructor.name ]);
                                              })());
                                          });
                                      }));
                                  };
                                  return Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))($foreign.sendNotification(v.notificationSound !== "")(makeAudioUrl(v.notificationSound))(getName(firstMessage.value0.authorId)(model3.events.folded.names))(firstMessage.value0.content));
                              };
                              if (firstMessage instanceof Data_Maybe.Nothing) {
                                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(Data_Unit.unit);
                              };
                              throw new Error("Failed pattern match at Main (line 362, column 15 - line 383, column 37): " + [ firstMessage.constructor.name ]);
                          })())(function () {
              ...
              throw new Error("Failed pattern match at Main (line 299, column 11 - line 387, column 34): " + [ v2.value0.constructor.name ]);
          };
          if (v2 instanceof ModelMsg.WebSocketOpened) {
          ...
          throw new Error("Failed pattern match at Main (line 117, column 7 - line 393, column 21): " + [ v2.constructor.name ]);
      };
  });
