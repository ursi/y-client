...
(function($PS) {
  ...
  var processEvents = function ($131) {
      return (function (v) {
          return {
              ...
              messages: TreeMap.toTreeMap(Y_Shared_Id.ordId)(Data_Functor.mapFlipped(Data_List_Types.functorList)(v.messageEvents)(function ($132) {
  ...
  var inputWithHeight = Attribute.on(Producer.produceab)("input")((function () {
      var $133 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(NoOp.value))(function (elem) {
      ...
      var $134 = WHATWG_HTML_Types.toMaybeHTMLTextAreaElement();
      var $135 = WHATWG_DOM_Event.unsafeTarget();
      return function ($136) {
  ...
  var hitEnter = (function () {
      var $137 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (kbe) {
      ...
      var $138 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($139) {
          return $137($138($139));
      };
  })();
  ...
  var detectSendMessage = Attribute.on(Producer.produceab)("keydown")((function () {
      var $140 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(NoOp.value))(function (kbe) {
      ...
      var $141 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($142) {
          return $140($141($142));
      };
  })());
  ...
  var update = function (v) {
      ...
      var focusInput = Platform.afterRender(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(WHATWG_HTML_Window.window)(WHATWG_HTML_Window.document))((function () {
          var $143 = Data_Functor.map(Effect.functorEffect)(WHATWG_HTML_Types.toMaybeHTMLElement());
          var $144 = WHATWG_DOM_Mixin_NonElementParentNode.getElementById()(inputId);
          return function ($145) {
              return $143($144($145));
          };
      ...
      return function (v2) {
          ...
          if (v2 instanceof TransmissionReceived) {
              if (v2.value0 instanceof Data_Maybe.Just) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))((function () {
                      if (v.notifying) {
                          return Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(function (mes) {
                              var $102 = Data_Eq.eq(Y_Shared_Id.eqId)(mes.authorId)(v.userId);
                              if ($102) {
                                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                              };
                      ...
                      throw new Error("Failed pattern match at Main (line 297, column 11 - line 310, column 35): " + [ v.thread.constructor.name ]);
                  });
              };
              if (v2.value0 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v);
              };
              throw new Error("Failed pattern match at Main (line 252, column 7 - line 312, column 30): " + [ v2.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Main (line 161, column 3 - line 320, column 23): " + [ v2.constructor.name ]);
      };
  };
      ...
      return Platform.batch([ Html.divS([ Css.margin("5px") ])([  ])([ Html.button([ Attribute.onClick(Producer.producea($dollar_EqMsg_41))(NewThread.value) ])([ Html.text("New Thread") ]) ]), Html.divS([ Css.overflow("auto"), Css.borderJ([ Design.vars.borderWidth1, "solid" ]) ])([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(leaves)(function (mid) {
          return (function (mes) {
              return Html.divS([ (function () {
                  var $123 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.thread)(new Data_Maybe.Just(mid));
                  if ($123) {
          ...
          })(Data_Maybe.maybe("oops")(function ($146) {
              return (function (v) {
                  return v.content;
              })((function (v) {
                  return v.value;
  ...
  var threadView = function (model) {
      ...
      var messageList = (function () {
          var $147 = Data_Functor.map(Data_Functor.functorArray)(function (v) {
              var createMessage = function (isSibling) {
                  return function (styles) {
                      return function (mes) {
                          return Html.divS([ Design.following([ Css.borderBottom("1px solid") ]), Css.padding(".25em"), Css.position("relative"), styles ])([ Attribute.onClick(Producer.producea($dollar_EqMsg_41))((function () {
                              if (isSibling) {
                                  return SelectSibling.create;
                              };
                              return SelectMessageParent.create;
                          })()(mes.id)) ])([ (function () {
                              var $126 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.messageParent)(new Data_Maybe.Just(mes.id));
                              if ($126) {
                          ...
                          })(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(getParent(mes)(model.state.messages))(PointFree.applySecond(function ($150) {
          ...
          var $148 = Data_Array.fromFoldable(Data_List_Types.foldableNonEmptyList);
          return function ($149) {
      ...
      return Html.divS([ Design.panel, Css.transform(Css_Functions.translateX(Css_Functions.calc(Css_Functions.sub("0px")(Design.vars.borderWidth1)))) ])([  ])([ (function () {
          ...
          throw new Error("Failed pattern match at Main (line 556, column 7 - line 558, column 26): " + [ mthread.constructor.name ]);
      })(), messageInput ]);
  };
