      ...
      return makeListener(function (msgCallback) {
          return function (event) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at Sub (line 143, column 9 - line 145, column 31): " + [ mmsg.constructor.name ]);
              };
          };
      });
  };
          ...
          return makeListener(function (msgCallback) {
              return function (event) {
                  return function __do() {
                      ...
                      throw new Error("Failed pattern match at Attribute (line 609, column 10 - line 611, column 32): " + [ mmsg.constructor.name ]);
                  };
              };
          })(v.value0);
      };
...
(function($PS) {
  ...
  exports["height"] = height;
  exports["prevContent"] = prevContent;
  exports["reset"] = reset;
              ...
              return (function (acc$prime) {
                  ...
                  if (v1.parent instanceof Data_Maybe.Just) {
                      ...
                      if (v2 instanceof Data_Maybe.Nothing) {
                          ...
                          throw new Error("Failed pattern match at TreeMap (line 66, column 19 - line 87, column 86): " + [ v3.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at TreeMap (line 55, column 15 - line 87, column 86): " + [ v2.constructor.name ]);
                  };
                  if (v1.parent instanceof Data_Maybe.Nothing) {
                      return v;
                  };
                  throw new Error("Failed pattern match at TreeMap (line 53, column 11 - line 89, column 27): " + [ v1.parent.constructor.name ]);
              })());
          };
      })({
  ...
  var removeLeaf = function (dictOrd) {
      return function (key) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at TreeMap (line 222, column 3 - line 268, column 18): " + [ v1.constructor.name ]);
          };
      };
  };
      ...
      return function (key) {
          return function (v) {
              ...
              if (v1 instanceof Data_Maybe.Nothing) {
                  ...
                  throw new Error("Failed pattern match at TreeMap (line 138, column 16 - line 140, column 40): " + [ v2.constructor.name ]);
              };
      ...
      return function (key) {
          return function (tm) {
              ...
              return Control_Bind.bind(Data_Either.bindEither)(lookupEither(dictOrd)(key)(tm))(function (v) {
                  ...
                  throw new Error("Failed pattern match at TreeMap (line 149, column 9 - line 154, column 30): " + [ v.parent.constructor.name ]);
              });
          };
      };
  };
                  ...
                  function $tco_loop(dictOrd, shouldRemove, key, tm) {
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          ...
                          if ($109) {
                              ...
                              throw new Error("Failed pattern match at TreeMap (line 281, column 9 - line 283, column 27): " + [ v.value0.parent.constructor.name ]);
                          };
                          $tco_done = true;
                          return tm;
                      };
                      ...
                      throw new Error("Failed pattern match at TreeMap (line 277, column 3 - line 287, column 18): " + [ v.constructor.name ]);
                  };
                  while (!$tco_done) {
                  ...
                  return function (f) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(lookup(dictOrd)(key)(tm))(function (v) {
                          ...
                          if (v1 instanceof Data_Either.Right) {
                              ...
                              throw new Error("Failed pattern match at TreeMap (line 168, column 17 - line 170, column 38): " + [ v.parent.constructor.name ]);
                          };
                          if (v1 instanceof Data_Either.Left) {
                              return Effect_Exception_Unsafe.unsafeThrow("Tree.purs: getThread");
                          };
                          throw new Error("Failed pattern match at TreeMap (line 165, column 13 - line 171, column 59): " + [ v1.constructor.name ]);
                      });
                  };
              };
      ...
      return function (key) {
          return function (oldTM) {
              return function (newTM) {
                  var $125 = member(dictOrd)(key)(newTM);
                  if ($125) {
                      return new Data_Maybe.Just(key);
                  };
      ...
      return function (id) {
          return function (tm) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(lookup(dictOrd)(id)(tm))(function (v) {
                  ...
                  throw new Error("Failed pattern match at TreeMap (line 193, column 9 - line 195, column 29): " + [ v1.constructor.name ]);
              });
          };
      };
  };
      ...
      return function (key) {
          return function (f) {
              return function (v) {
                  ...
                  throw new Error("Failed pattern match at TreeMap (line 202, column 3 - line 211, column 16): " + [ v1.constructor.name ]);
              };
          };
      };
  };
...
(function($PS) {
  ...
  var processEvents = function ($189) {
      return (function (events) {
          return {
              ...
              messages: (function () {
                  var initialTM = TreeMap.toTreeMap(Y_Shared_Id.ordId)(Data_Functor.mapFlipped(Data_List_Types.functorList)(events.messageSend)(function ($190) {
                  ...
                  return PointFree.applySecond(Data_Foldable.foldl(Data_List_Types.foldableList)(function (acc) {
                      ...
                      return function (v) {
                          return TreeMap.removeLeafRecursive(Y_Shared_Id.ordId)(function ($191) {
                              return (function (v1) {
                                  return v1.deleted;
                              })((function (v1) {
                                  return v1.value;
  ...
  var inputWithHeight = Attribute.on(Producer.produceab)("input")((function () {
      var $192 = WHATWG_HTML_Types.toMaybeHTMLTextAreaElement();
      var $193 = WHATWG_DOM_Event.unsafeTarget();
      return function ($194) {
          return (function (v) {
              if (v instanceof Data_Maybe.Just) {
                  return Control_Apply.lift2(Effect.applyEffect)(function (content) {
                      return function (height) {
                          return Data_Maybe.Just.create(new UpdateInputBox(content, height + Design.inputBoxBorderWidth));
                      };
                  })(WHATWG_HTML_HTMLTextAreaElement.value(v.value0))(Data_Functor.map(Effect.functorEffect)(Data_Int.toNumber)(WHATWG_DOM_Element.scrollHeight()(v.value0)));
              };
              if (v instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value);
              };
              throw new Error("Failed pattern match at Main (line 857, column 6 - line 869, column 31): " + [ v.constructor.name ]);
          })($192($193($194)));
      };
  })());
  var inputId = "input";
          ...
          return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(function __do() {
              ...
              return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(Y_Client_WebSocket.newConnection({
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Control_Monad_Writer_Class.tell(Control_Monad_Writer_Trans.monadTellWriterT(Platform["$_MonoidCmd_10"])(Effect.monadEffect))(function (msgCallback) {
                      return Y_Client_WebSocket.onOpen(msgCallback(WebSocketOpened.value))(wsClient);
                  }))(function () {
  ...
  var hitEnter = (function () {
      var $195 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($196) {
          return (function (v) {
              if (v instanceof Data_Maybe.Just) {
                  var $99 = WHATWG_HTML_KeyboardEvent.key(v.value0) === "Enter";
                  if ($99) {
                      return function __do() {
                          var document = Control_Bind.bind(Effect.bindEffect)(WHATWG_HTML_Window.window)(WHATWG_HTML_Window.document)();
                          var body = WHATWG_HTML_Document.unsafeBody(document)();
                          var v1 = WHATWG_HTML_Mixin_DocumentOrShadowRoot.activeElement()(document)();
                          if (v1 instanceof Data_Maybe.Just) {
                              var $101 = Data_Eq.eq(RefEq.eqRefEq)(new RefEq.RefEq(body))(new RefEq.RefEq(v1.value0));
                              if ($101) {
                          ...
                          throw new Error("Failed pattern match at Main (line 574, column 13 - line 586, column 38): " + [ v1.constructor.name ]);
                      };
                  };
                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value);
              };
              ...
              throw new Error("Failed pattern match at Main (line 568, column 6 - line 590, column 30): " + [ v.constructor.name ]);
          })($195($196));
      };
  })();
  ...
  var formatTimeDiff = function (iOld) {
      return function (iNew) {
          ...
          var $107 = Data_Int.round(seconds) < 120;
          if ($107) {
              return show$prime(seconds)("s");
          };
          var minutes = seconds / 60.0;
          var $108 = Data_Int.round(minutes) < 120;
          if ($108) {
  ...
  var subscriptions = function (model) {
      return Platform.batch([ WebSocketSub.wsToSub(TransmissionReceived.create)(model.wsClient), Sub.on(Producer.produceab)("keydown")(hitEnter), Sub.on(Producer.produceab)("focus")(focusHandler) ]);
  };
  var eventTime = function (v) {
      return v.time;
  };
  var detectInputEvents = Attribute.on(Producer.produceab)("keydown")((function () {
      var $197 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($198) {
          return (function (v) {
              if (v instanceof Data_Maybe.Just) {
                  var $113 = WHATWG_HTML_KeyboardEvent.key(v.value0) === "Enter" && (WHATWG_HTML_KeyboardEvent.ctrlKey(v.value0) || WHATWG_HTML_KeyboardEvent.metaKey(v.value0));
                  if ($113) {
                      return function __do() {
                          WHATWG_DOM_Event.preventDefault()(v.value0)();
                  ...
                  var $114 = WHATWG_HTML_KeyboardEvent.key(v.value0) === "z" && WHATWG_HTML_KeyboardEvent.ctrlKey(v.value0);
                  if ($114) {
                      return function __do() {
                          WHATWG_DOM_Event.preventDefault()(v.value0)();
              ...
              throw new Error("Failed pattern match at Main (line 875, column 6 - line 886, column 31): " + [ v.constructor.name ]);
          })($197($198));
      };
  })());
  var addEvents = function (events) {
      return function (newEvents) {
          ...
          if (oldEnd instanceof Data_Maybe.Just && newHead instanceof Data_Maybe.Just) {
              var $118 = Data_Ord.lessThanOrEq(Y_Shared_Util_Instant.ordInstant)(oldEnd.value0.time)(newHead.value0.time);
              if ($118) {
  ...
  var update = function (v) {
      ...
      var focusInput = Platform.afterRender(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(WHATWG_HTML_Window.window)(WHATWG_HTML_Window.document))((function () {
          var $199 = Data_Functor.map(Effect.functorEffect)(WHATWG_HTML_Types.toMaybeHTMLElement());
          var $200 = WHATWG_DOM_Mixin_NonElementParentNode.getElementById()(inputId);
          return function ($201) {
              return $199($200($201));
          };
      ...
      return function (v2) {
          ...
          if (v2 instanceof SelectSibling) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(focusInput)(function () {
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                      ...
                      thread: TreeMap.findLeaf(Y_Shared_Id.ordId)(v2.value0)(v.state.messages),
                      convoId: v.convoId,
                      inputBox: v.inputBox,
                      nameInput: v.nameInput,
                      state: v.state,
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(focusInput)(function () {
                  ...
                  if ($128) {
                      return Data_Maybe.fromMaybe(Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v))(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(v.state.messages))(function (v3) {
                              return new Data_Maybe.Just((function () {
                                  var $130 = Data_Eq.eq(Y_Shared_Id.eqId)(v3.value.authorId)(v.userId);
                                  if ($130) {
                  ...
                  var $132 = Data_String_Utils.startsWith("/edit ")(content);
                  if ($132) {
                      return Data_Maybe.fromMaybe(Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v))(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(v.state.messages))(function (v3) {
                              return new Data_Maybe.Just((function () {
                                  var $134 = Data_Eq.eq(Y_Shared_Id.eqId)(v3.value.authorId)(v.userId);
                                  if ($134) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(pushEvent(v)(function (v4) {
          ...
          if (v2 instanceof UpdateInputBox) {
              var model2 = {
                  inputBox: InputBox.update(v2.value0)(v2.value1)(v.inputBox),
                  convoId: v.convoId,
                  messageParent: v.messageParent,
                  nameInput: v.nameInput,
                  state: v.state,
              ...
              var $138 = v2.value0 === "/edit " && InputBox.prevContent(model2.inputBox) === "/edit";
              if ($138) {
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(Data_Maybe.fromMaybe(model2)(Control_Bind.bind(Data_Maybe.bindMaybe)(model2.messageParent)(function (mid) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(model2.state.messages))(function (v3) {
                          return new Data_Maybe.Just((function () {
                              if (v3.value.deleted) {
                                  return model2;
                              };
                              return {
                                  inputBox: InputBox.update("/edit " + v3.value.content)(v2.value1)(v.inputBox),
          ...
          if (v2 instanceof TransmissionReceived) {
              if (v2.value0 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))($foreign.hasFocus))(function (focused) {
                      ...
                      var newLeaf = PointFree.applySecond(PointFree.applySecond(TreeMap.findNewLeaf(Y_Shared_Id.ordId))(v.state.messages))(processedEvents.messages);
                      var model2 = {
                          state: {
                              events: newEvents,
                          ...
                          messageParent: Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(newLeaf),
                          thread: Control_Bind.bind(Data_Maybe.bindMaybe)(v.thread)(newLeaf),
                          unread: (function () {
                              if (focused) {
                                  return false;
                              };
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))((function () {
                          if (firstMessage instanceof Data_Maybe.Just) {
                              var $148 = Data_Eq.eq(Y_Shared_Id.eqId)(firstMessage.value0.authorId)(v.userId);
                              if ($148) {
                                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                              };
                              return $foreign.sendNotification(getName(firstMessage.value0.authorId)(model2.state.names))(firstMessage.value0.content);
                          };
                          if (firstMessage instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                          };
                          throw new Error("Failed pattern match at Main (line 373, column 14 - line 382, column 36): " + [ firstMessage.constructor.name ]);
                      })()))(function () {
                          if (model2.thread instanceof Data_Maybe.Just) {
                              var mleaf = TreeMap.findLeaf(Y_Shared_Id.ordId)(model2.thread.value0)(processedEvents.messages);
                              return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                                  thread: mleaf,
                                  messageParent: (function () {
                                      var $151 = InputBox.content(v.inputBox) === "";
                                      if ($151) {
                                          return mleaf;
                                      };
                                      return model2.messageParent;
                                  })(),
                                  nameInput: model2.nameInput,
                                  state: model2.state,
                                  unread: model2.unread,
                          ...
                          if (model2.thread instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(model2);
                          };
                          throw new Error("Failed pattern match at Main (line 385, column 11 - line 398, column 35): " + [ model2.thread.constructor.name ]);
                      });
                  });
              };
              ...
              throw new Error("Failed pattern match at Main (line 334, column 7 - line 400, column 30): " + [ v2.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Main (line 160, column 3 - line 406, column 17): " + [ v2.constructor.name ]);
      };
  };
  var $dollar_EqMsg_65 = new Data_Eq.Eq(function (v) {
      return function (v1) {
          ...
          if (v instanceof SelectThreadRoot && v1 instanceof SelectThreadRoot) {
  ...
  var threadBar = function (model) {
      ...
      return Platform.batch([ Html.divS([ Css.margin("5px") ])([  ])([ Html.button([ Attribute.onClick(Producer.producea($dollar_EqMsg_65))(NewThread.value) ])([ Html.text("New Thread") ]) ]), Html.divS([ Css.overflow("auto"), Css.borderJ([ Design.vars.borderWidth1, "solid" ]) ])([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(leaves)(function (mid) {
          return (function (v) {
              if (v instanceof Data_Maybe.Just) {
                  if (v.value0.value.deleted) {
                      return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]);
                  };
                  return Html.divS([ (function () {
                      var $174 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.thread)(new Data_Maybe.Just(mid));
                      if ($174) {
                          return Css.background(Design.vars.accent1);
                      };
                      return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]);
                  })(), Design.following([ Css.borderTop("1px solid") ]), Css.padding(".3em"), Css.whiteSpace("pre-wrap"), Css.overflow("auto") ])([ onNotSelectingClick(new SelectThreadRoot(mid)) ])([ Html.text(v.value0.value.content) ]);
              };
              if (v instanceof Data_Maybe.Nothing) {
                  return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]);
              };
              throw new Error("Failed pattern match at Main (line 655, column 15 - line 673, column 34): " + [ v.constructor.name ]);
          })(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(model.state.messages));
      })) ]);
  };
  var threadView = function (model) {
      var mthread = Control_Bind.bind(Data_Maybe.bindMaybe)(model.thread)(PointFree.applySecond(TreeMap.getThread(Y_Shared_Id.ordId))(model.state.messages));
                  ...
                  return function (styles) {
                      return function (mes) {
                          return Html.divS([ Design.following([ Css.borderBottom("1px solid") ]), Css.position("relative"), Css.padding("3px .25em 6px .25em"), styles ])([ onNotSelectingClick((function () {
                              ...
                              var $181 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.messageParent)(new Data_Maybe.Just(mes.id));
                              if ($181) {
                              ...
                              return Html.divS([ Css.font("0.72em sans-serif"), Css.opacity("0.6"), Css.marginBottom("0.7em") ])([  ])([ Html.text(getName(mes.authorId)(model.state.names)), (function (v1) {
                                  if (v1 instanceof Data_Maybe.Just) {
                                  ...
                                  throw new Error("Failed pattern match at Main (line 773, column 33 - line 779, column 52): " + [ v1.constructor.name ]);
                              })(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(getParent(mes)(model.state.messages))(PointFree.applySecond(function ($208) {
