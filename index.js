...
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
  $PS["Y.Shared.Config"] = $PS["Y.Shared.Config"] || {};
  var exports = $PS["Y.Shared.Config"];
...
(function($PS) {
  ...
  var Y_Client_WebSocket = $PS["Y.Client.WebSocket"];
  var Y_Shared_Config = $PS["Y.Shared.Config"];
  var Y_Shared_Event = $PS["Y.Shared.Event"];
  var Y_Shared_Id = $PS["Y.Shared.Id"];
  var Y_Shared_Transmission = $PS["Y.Shared.Transmission"];
  var Y_Shared_Util_Codable = $PS["Y.Shared.Util.Codable"];
  ...
  var init = function (v) {
      return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(function __do() {
          ...
          return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(Y_Client_WebSocket.newConnection({
              url: "wss://y.maynards.site:" + Data_Show.show(Data_Show.showInt)(Y_Shared_Config.webSocketPort)
          })))(function (wsClient) {
  ...
  var update = function (v) {
      ...
      return function (v2) {
          ...
          throw new Error("Failed pattern match at Main (line 145, column 3 - line 274, column 23): " + [ v2.constructor.name ]);
      };
  };
  ...
  var threadBar = function (model) {
      ...
      return Platform.batch([ Html.divS([ Css.margin("5px") ])([  ])([ Html.button([ Attribute.onClick(Producer.producea($dollar_EqMsg_32))(NewThread.value) ])([ Html.text("New Thread") ]) ]), Html.divS([ Css.overflow("auto") ])([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(leaves)(function (mid) {
          return (function (mes) {
              ...
              })(), Css.border("1px solid"), Css.padding(".3em"), Css.whiteSpace("pre-wrap"), Css.overflow("auto") ])([ Attribute.onClick(Producer.producea($dollar_EqMsg_32))(new SelectThreadRoot(mid)) ])([ Html.text(mes) ]);
  ...
  var threadView = function (model) {
      ...
      var messageInput = Html.div([  ])([ Html.textareaS([ Css.height(Css.px(model.inputBox.height)), Css.width("100%"), Css.borderWidth(Css.px(Design.inputBoxBorderWidth)), Css.padding(".45em") ])([ Attribute.id(inputId), Attribute.value(model.inputBox.content), inputWithHeight, detectSendMessage ])([  ]) ]);
      if (mthread instanceof Data_Maybe.Just) {
          return (function (messagesHtml) {
              return Html.divS([ Design.panel ])([  ])([ Html.divS([ Css.border("1px solid"), Css.overflow("auto"), Css.display("flex"), Css.flexDirection("column-reverse") ])([  ])(messagesHtml), messageInput ]);
          })(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              var createMessage = function (styles) {
                  return function (mes) {
                      return Html.divS([ Css.border("1px solid darkgray"), Css.padding(".25em"), Css.position("relative"), styles ])([ Attribute.onClick(Producer.producea($dollar_EqMsg_32))(new SelectMessageParent(mes.id)) ])([ (function () {
      ...
      throw new Error("Failed pattern match at Main (line 487, column 3 - line 558, column 28): " + [ mthread.constructor.name ]);
  };
