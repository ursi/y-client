...
(function($PS) {
  ...
  var processEvents = function ($118) {
      return (function (v) {
          return {
              ...
              messages: TreeMap.toTreeMap(Y_Shared_Id.ordId)(Data_Functor.mapFlipped(Data_List_Types.functorList)(v.messageEvents)(function ($119) {
  ...
  var inputWithHeight = Attribute.on(Producer.produceab)("input")((function () {
      var $120 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(NoOp.value))(function (elem) {
      ...
      var $121 = WHATWG_HTML_Types.toMaybeHTMLTextAreaElement();
      var $122 = WHATWG_DOM_Event.unsafeTarget();
      return function ($123) {
  ...
  var formatTimeDiff = function (iOld) {
      return function (iNew) {
          ...
          var $62 = Data_Int.round(seconds) < 120;
          if ($62) {
              return show$prime(seconds)("s");
          };
          var minutes = seconds / 60.0;
          var $63 = Data_Int.round(minutes) < 120;
          if ($63) {
  ...
  var detectSendMessage = Attribute.on(Producer.produceab)("keydown")((function () {
      var $124 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(NoOp.value))(function (kbe) {
          var $67 = WHATWG_HTML_KeyboardEvent.key(kbe) === "Enter" && (WHATWG_HTML_KeyboardEvent.ctrlKey(kbe) || WHATWG_HTML_KeyboardEvent.metaKey(kbe));
          if ($67) {
              return function __do() {
      ...
      var $125 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($126) {
          return $124($125($126));
      };
  })());
  ...
  var addEvents = function (events) {
      return function (newEvents) {
          ...
          if (oldEnd instanceof Data_Maybe.Just && newHead instanceof Data_Maybe.Just) {
              var $76 = Data_Ord.lessThanOrEq(Y_Shared_Util_Instant.ordInstant)(oldEnd.value0.time)(newHead.value0.time);
              if ($76) {
  ...
  var update = function (v) {
      ...
      var focusInput = Platform.afterRender(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(WHATWG_HTML_Window.window)(WHATWG_HTML_Window.document))((function () {
          var $127 = Data_Functor.map(Effect.functorEffect)(WHATWG_HTML_Types.toMaybeHTMLElement());
          var $128 = WHATWG_DOM_Mixin_NonElementParentNode.getElementById()(inputId);
          return function ($129) {
              return $127($128($129));
          };
      ...
      return function (v2) {
          ...
          if (v2 instanceof TransmissionReceived) {
              if (v2.value0 instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Main (line 253, column 9 - line 266, column 33): " + [ v.selectedThreadRoot.constructor.name ]);
              };
              if (v2.value0 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v);
              };
              throw new Error("Failed pattern match at Main (line 230, column 33 - line 268, column 28): " + [ v2.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Main (line 146, column 3 - line 276, column 23): " + [ v2.constructor.name ]);
      };
  };
  var $dollar_EqMsg_36 = new Data_Eq.Eq(function (m1) {
      return function (m2) {
          if (m1 instanceof UpdateInputBox && m2 instanceof UpdateInputBox) {
              return Data_Eq.eq(Data_Eq.eqRec()(Data_Eq.eqRowCons(Data_Eq.eqRowCons(Data_Eq.eqRowNil)()(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "content";
              }))(Data_Eq.eqString)))(m1.value0)(m2.value0);
          };
          ...
          if (m1 instanceof NoOp && m2 instanceof NoOp) {
              return true;
          };
          return false;
      };
  ...
  var threadBar = function (model) {
      ...
      return Platform.batch([ Html.divS([ Css.margin("5px") ])([  ])([ Html.button([ Attribute.onClick(Producer.producea($dollar_EqMsg_36))(NewThread.value) ])([ Html.text("New Thread") ]) ]), Html.divS([ Css.overflow("auto"), Css.borderJ([ Design.vars.borderWidth1, "solid" ]) ])([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(leaves)(function (mid) {
          return (function (mes) {
              return Html.divS([ (function () {
                  var $111 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.selectedThreadRoot)(new Data_Maybe.Just(mid));
                  if ($111) {
                      return Css.background(Design.vars.accent1);
                  };
                  return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]);
              })(), Design.following([ Css.borderTop("1px solid") ]), Css.padding(".3em"), Css.whiteSpace("pre-wrap"), Css.overflow("auto") ])([ Attribute.onClick(Producer.producea($dollar_EqMsg_36))(new SelectThreadRoot(mid)) ])([ Html.text(mes) ]);
          })(Data_Maybe.maybe("oops")(function ($130) {
              return (function (v) {
                  return v.content;
              })((function (v) {
                  return v.value;
  ...
  var threadView = function (model) {
      ...
      var messageList = (function () {
          var $131 = Data_Functor.map(Data_Functor.functorArray)(function (v) {
              var createMessage = function (styles) {
                  return function (mes) {
                      return Html.divS([ Design.following([ Css.borderBottom("1px solid") ]), Css.padding(".25em"), Css.position("relative"), styles ])([ Attribute.onClick(Producer.producea($dollar_EqMsg_36))(new SelectMessageParent(mes.id)) ])([ (function () {
                          var $113 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.messageParent)(new Data_Maybe.Just(mes.id));
                          if ($113) {
                          ...
                          return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]);
                      })(), Html.divS([ Css.font("0.72em sans-serif"), Css.opacity("0.6"), Css.marginBottom("0.7em"), Css.paddingTop("1px") ])([  ])([ Html.text(Data_Maybe.fromMaybe("<anonymous>")(Data_Map_Internal.lookup(Y_Shared_Id.ordId)(mes.authorId)(model.state.names))), Data_Maybe.maybe(Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]))(function (diff) {
                      ...
                      })(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(getParent(mes)(model.state.messages))(PointFree.applySecond(function ($134) {
              ...
              return Platform.batch(Data_Array.reverse(Data_Array.snoc(Data_Functor.mapFlipped(Data_Functor.functorArray)(v.value1)(createMessage(Css.background(Design.vars.lighterBackground22))))(createMessage(Css.background(Design.vars.background))(v.value0))));
          });
          var $132 = Data_Array.fromFoldable(Data_List_Types.foldableNonEmptyList);
          return function ($133) {
      ...
      return Html.divS([ Design.panel, Css.transform(Css_Functions.translateX(Css_Functions.calc(Css_Functions.sub("0px")(Design.vars.borderWidth1)))) ])([  ])([ (function () {
          ...
          throw new Error("Failed pattern match at Main (line 481, column 7 - line 483, column 26): " + [ mthread.constructor.name ]);
      })(), messageInput ]);
  };
