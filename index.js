...
(function($PS) {
  ...
  var toTreeMap = function (dictOrd) {
      var $140 = Data_Foldable.foldl(Data_List_Types.foldableList)(function (v) {
          return function (v1) {
              ...
              return Control_Bind.bind(Data_Either.bindEither)(lookupEither(dictOrd)(key)(tm))(function (v) {
                  if (v.parent instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Functor.mapFlipped(Data_Either.functorEither)(find(v.parent.value0))((function () {
                          var $142 = Data_Array["delete"](dictOrd.Eq0())(key);
                          return function ($143) {
                              return $142((function (v1) {
                                  return v1.children;
                              })($143));
                          };
                      })()))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)((function () {
                          var $144 = Data_Functor.map(Data_Either.functorEither)(function (v1) {
                              return v1.value;
                          });
                          return function ($145) {
                              return $144(find($145));
          ...
          return function ($copy_key) {
              return function ($copy_tm) {
                  ...
                  function $tco_loop(dictOrd, shouldRemove, key, tm) {
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          var $109 = Data_Eq.eq(Data_Eq.eqArray(dictOrd.Eq0()))(v.value0.children)([  ]);
                          if ($109) {
                              var $110 = shouldRemove(v.value0);
                              if ($110) {
                                  ...
                                  throw new Error("Failed pattern match at TreeMap (line 282, column 11 - line 284, column 29): " + [ v.value0.parent.constructor.name ]);
                              };
                              $tco_done = true;
                              return tm;
                          };
                      ...
                      throw new Error("Failed pattern match at TreeMap (line 277, column 3 - line 290, column 18): " + [ v.constructor.name ]);
                  };
                  while (!$tco_done) {
      ...
      return function (key) {
          return function (oldTM) {
              return function (newTM) {
                  var $126 = member(dictOrd)(key)(newTM);
                  if ($126) {
...
(function($PS) {
  ...
  var UpdateInputBox = (function () {
      function UpdateInputBox(value0) {
          this.value0 = value0;
      };
      UpdateInputBox.create = function (value0) {
          return new UpdateInputBox(value0);
      };
  ...
  var processEvents = function ($175) {
      return (function (events) {
          return {
              ...
              messages: (function () {
                  var initialTM = TreeMap.toTreeMap(Y_Shared_Id.ordId)(Data_Functor.mapFlipped(Data_List_Types.functorList)(events.messageSend)(function ($176) {
                  ...
                  return PointFree.applySecond(Data_Foldable.foldl(Data_List_Types.foldableList)(function (acc) {
                      ...
                      return function (v) {
                          return TreeMap.removeLeafRecursive(Y_Shared_Id.ordId)(function ($177) {
                              return (function (v1) {
                                  return v1.deleted;
                              })((function (v1) {
                                  return v1.value;
  ...
  var inputWithHeight = Attribute.on(Producer.produceab)("input")((function () {
      var $178 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (elem) {
          return Control_Apply.lift2(Effect.applyEffect)(function (content) {
              return function (height) {
                  return Data_Maybe.Just.create(new UpdateInputBox({
                      content: content,
                      height: height + Design.inputBoxBorderWidth
                  }));
              };
          })(WHATWG_HTML_HTMLTextAreaElement.value(elem))(Data_Functor.map(Effect.functorEffect)(Data_Int.toNumber)(WHATWG_DOM_Element.scrollHeight()(elem)));
      });
      var $179 = WHATWG_HTML_Types.toMaybeHTMLTextAreaElement();
      var $180 = WHATWG_DOM_Event.unsafeTarget();
      return function ($181) {
  ...
  var hitEnter = (function () {
      var $182 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (kbe) {
          var $90 = WHATWG_HTML_KeyboardEvent.key(kbe) === "Enter";
          if ($90) {
              return function __do() {
                  ...
                  var mactiveElement = WHATWG_HTML_Mixin_DocumentOrShadowRoot.activeElement()(document)();
                  return Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (activeElement) {
                      var $91 = Data_Eq.eq(RefEq.eqRefEq)(new RefEq.RefEq(body))(new RefEq.RefEq(activeElement));
                      if ($91) {
                          return function __do() {
                              ...
                              WHATWG_DOM_Event.preventDefault()(kbe)();
                              return Data_Maybe.Nothing.value;
                          };
                      };
      ...
      var $183 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($184) {
          return $182($183($184));
      };
  })();
  ...
  var formatTimeDiff = function (iOld) {
      return function (iNew) {
          ...
          var $95 = Data_Int.round(seconds) < 120;
          if ($95) {
              return show$prime(seconds)("s");
          };
          var minutes = seconds / 60.0;
          var $96 = Data_Int.round(minutes) < 120;
          if ($96) {
  ...
  var detectSendMessage = Attribute.on(Producer.produceab)("keydown")((function () {
      var $185 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (kbe) {
          var $100 = WHATWG_HTML_KeyboardEvent.key(kbe) === "Enter" && (WHATWG_HTML_KeyboardEvent.ctrlKey(kbe) || WHATWG_HTML_KeyboardEvent.metaKey(kbe));
          if ($100) {
              return function __do() {
                  WHATWG_DOM_Event.preventDefault()(kbe)();
      ...
      var $186 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($187) {
          return $185($186($187));
      };
  })());
  ...
  var addEvents = function (events) {
      return function (newEvents) {
          ...
          if (oldEnd instanceof Data_Maybe.Just && newHead instanceof Data_Maybe.Just) {
              var $109 = Data_Ord.lessThanOrEq(Y_Shared_Util_Instant.ordInstant)(oldEnd.value0.time)(newHead.value0.time);
              if ($109) {
  ...
  var update = function (v) {
      ...
      var focusInput = Platform.afterRender(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(WHATWG_HTML_Window.window)(WHATWG_HTML_Window.document))((function () {
          var $188 = Data_Functor.map(Effect.functorEffect)(WHATWG_HTML_Types.toMaybeHTMLElement());
          var $189 = WHATWG_DOM_Mixin_NonElementParentNode.getElementById()(inputId);
          return function ($190) {
              return $188($189($190));
          };
      ...
      return function (v2) {
          ...
          if (v2 instanceof SendMessage) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(focusInput)(function () {
                  var $118 = v.inputBox.content === "";
                  if ($118) {
                      return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v);
                  };
                  var $119 = v.inputBox.content === "/delete";
                  if ($119) {
                      return Data_Maybe.fromMaybe(Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v))(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(v.state.messages))(function (v3) {
                              return new Data_Maybe.Just((function () {
                                  var $121 = Data_Eq.eq(Y_Shared_Id.eqId)(v3.value.authorId)(v.userId);
                                  if ($121) {
                                  ...
                                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                                      inputBox: {
                                          content: "You didn't send that message!",
                                          height: v.inputBox.height
                                      },
                                      convoId: v.convoId,
                                      messageParent: v.messageParent,
                                      nameInput: v.nameInput,
                  ...
                  var $123 = Data_String_Utils.startsWith("/edit ")(v.inputBox.content);
                  if ($123) {
                      return Data_Maybe.fromMaybe(Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v))(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(v.state.messages))(function (v3) {
                              return new Data_Maybe.Just((function () {
                                  var $125 = Data_Eq.eq(Y_Shared_Id.eqId)(v3.value.authorId)(v.userId);
                                  if ($125) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(pushEvent(v)(function (v4) {
                                          return new Y_Shared_Event.EventPayload_MessageEdit({
                                              ...
                                              messageId: v3.value.id,
                                              authorId: v.userId,
                                              content: Data_String_CodePoints.drop(6)(v.inputBox.content)
                                          });
                                      })))(function () {
                                          return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                                              inputBox: defaultInputBox,
          ...
          if (v2 instanceof UpdateInputBox) {
              var $129 = v2.value0.content === "/edit ";
              if ($129) {
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(Data_Maybe.fromMaybe({
                      inputBox: v2.value0,
                      convoId: v.convoId,
                      messageParent: v.messageParent,
                      nameInput: v.nameInput,
                      ...
                      userId: v.userId,
                      wsClient: v.wsClient
                  })(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(v.state.messages))(function (v3) {
                          return new Data_Maybe.Just((function () {
                              if (v3.value.deleted) {
                                  return {
          ...
          if (v2 instanceof TransmissionReceived) {
              if (v2.value0 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))($foreign.hasFocus))(function (focused) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(function (mes) {
                          var $138 = Data_Eq.eq(Y_Shared_Id.eqId)(mes.authorId)(v.userId);
                          if ($138) {
                              return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                          };
                          return $foreign.sendNotification(getName(mes.authorId)(model2.state.names))(mes.content);
                          ...
                          throw new Error("Failed pattern match at Main (line 376, column 11 - line 389, column 35): " + [ model2.thread.constructor.name ]);
                      });
                  });
              };
              ...
              throw new Error("Failed pattern match at Main (line 325, column 7 - line 391, column 30): " + [ v2.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Main (line 164, column 3 - line 397, column 17): " + [ v2.constructor.name ]);
      };
  };
  ...
  var onNotSelectingClick = (function () {
      var $191 = Attribute.on(Producer.produceProducer)("click");
      var $192 = Producer.producer($dollar_EqMsg_65)(onNotSelectingClickRE);
      return function ($193) {
          return $191($192($193));
      };
  })();
  var threadBar = function (model) {
      ...
      return Platform.batch([ Html.divS([ Css.margin("5px") ])([  ])([ Html.button([ Attribute.onClick(Producer.producea($dollar_EqMsg_65))(NewThread.value) ])([ Html.text("New Thread") ]) ]), Html.divS([ Css.overflow("auto"), Css.borderJ([ Design.vars.borderWidth1, "solid" ]) ])([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(leaves)(function (mid) {
          return Data_Maybe.maybe(Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]))(function (v) {
              if (v.value.deleted) {
                  return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]);
              };
              return Html.divS([ (function () {
                  var $161 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.thread)(new Data_Maybe.Just(mid));
                  if ($161) {
                      return Css.background(Design.vars.accent1);
                  };
                  return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]);
              })(), Design.following([ Css.borderTop("1px solid") ]), Css.padding(".3em"), Css.whiteSpace("pre-wrap"), Css.overflow("auto") ])([ onNotSelectingClick(new SelectThreadRoot(mid)) ])([ Html.text(v.value.content) ]);
  ...
  var threadView = function (model) {
      ...
      var messageList = (function () {
          var $194 = Data_Functor.map(Data_Functor.functorArray)(function (v) {
                  ...
                  return function (styles) {
                      return function (mes) {
                          return Html.divS([ Design.following([ Css.borderBottom("1px solid") ]), Css.position("relative"), Css.padding("3px .25em 6px .25em"), styles ])([ onNotSelectingClick((function () {
                              ...
                              var $167 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.messageParent)(new Data_Maybe.Just(mes.id));
                              if ($167) {
                              ...
                              return Html.divS([ Css.font("0.72em sans-serif"), Css.opacity("0.6"), Css.marginBottom("0.7em") ])([  ])([ Html.text(getName(mes.authorId)(model.state.names)), Data_Maybe.maybe(Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]))(function (diff) {
                                  return Html.spanS([ Css.marginLeft("12px") ])([ Attribute.title($foreign.dateString(Y_Shared_Util_Instant.asMilliseconds(mes.timeSent))) ])([ Html.text(diff) ]);
                              })(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(getParent(mes)(model.state.messages))(PointFree.applySecond(function ($197) {
          ...
          var $195 = Data_Array.fromFoldable(Data_List_Types.foldableNonEmptyList);
          return function ($196) {
      ...
      var messageInput = Html.divS([ Css.display("flex"), Css.width(Css_Functions.calc(Css_Functions.add("100%")(Design.vars.borderWidth1))) ])([  ])([ Html.textareaS([ Css.height(Css.px(model.inputBox.height)), Css.flex("1"), Css.borderJ([ Css.px(Design.inputBoxBorderWidth), "solid", Design.vars.color ]), Css.padding(".45em"), Design.inputStyles, Css.borderTop("none") ])([ Attribute.id(inputId), Attribute.value(model.inputBox.content), inputWithHeight, detectSendMessage ])([  ]), Html.button([ Attribute.onClick(Producer.producea($dollar_EqMsg_65))(SendMessage.value) ])([ Html.text("Send") ]) ]);
      return Html.divS([ Design.panel, Css.transform(Css_Functions.translateX(Css_Functions.calc(Css_Functions.sub("0px")(Design.vars.borderWidth1)))) ])([  ])([ (function () {
          ...
          throw new Error("Failed pattern match at Main (line 678, column 7 - line 680, column 26): " + [ mthread.constructor.name ]);
      })(), messageInput ]);
  };
