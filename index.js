...
(function($PS) {
  ...
  var WHATWG_Internal = $PS["WHATWG.Internal"];                
  var shiftKey = WHATWG_Internal.unsafeGetPure("shiftKey");
...
(function($PS) {
  ...
  var detectSendMessage = Attribute.on(Producer.produceab)("keydown")((function () {
      var $113 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(NoOp.value))(function (kbe) {
          var $56 = WHATWG_HTML_KeyboardEvent.key(kbe) === "Enter" && (WHATWG_HTML_KeyboardEvent.ctrlKey(kbe) || (WHATWG_HTML_KeyboardEvent.metaKey(kbe) || WHATWG_HTML_KeyboardEvent.shiftKey(kbe)));
          if ($56) {
              return function __do() {
