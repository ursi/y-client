...
(function($PS) {
  ...
  var NoDiff = (function () {
      function NoDiff(value0) {
          this.value0 = value0;
      };
      NoDiff.create = function (value0) {
          return new NoDiff(value0);
      };
      return NoDiff;
  })();
          ...
          var go = function ($copy_acc) {
              return function ($copy_v) {
                  ...
                  function $tco_loop(acc, v) {
                      ...
                      if (v instanceof NoDiff) {
                          $tco_var_acc = acc;
                          $copy_v = v.value0;
                          return;
                      };
                      throw new Error("Failed pattern match at VirtualDom (line 536, column 5 - line 550, column 27): " + [ v.constructor.name ]);
                  };
                  while (!$tco_done) {
                      $tco_result = $tco_loop($tco_var_acc, $copy_v);
                  };
  ...
  var removeAttribute = function ($copy_attr) {
      return function ($copy_elem) {
          ...
          function $tco_loop(attr, elem) {
              ...
              if (attr instanceof NoDiff) {
                  $tco_var_attr = attr.value0;
                  $copy_elem = elem;
                  return;
              };
              throw new Error("Failed pattern match at VirtualDom (line 424, column 3 - line 429, column 39): " + [ attr.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var getNode = function (v) {
      ...
      throw new Error("Failed pattern match at VirtualDom (line 441, column 11 - line 444, column 33): " + [ v.constructor.name ]);
  };
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Control_Monad_Writer_Class.tell(Control_Monad_Reader_Trans.monadTellReaderT(Control_Monad_Writer_Trans.monadTellWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect)))(new Data_Tuple.Tuple(subs, Data_Monoid.mempty(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))))(function () {
                              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Effect_Class.liftEffect(Control_Monad_Reader_Trans.monadEffectReader(Control_Monad_Writer_Trans.monadEffectWriter(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect_Class.monadEffectEffect)))(placer({
                                  ...
                                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Data_Traversable.traverse(Data_List_Types.traversableList)(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))((function () {
                                      var $227 = Control_Monad_Reader_Class.local(Control_Monad_Reader_Trans.monadReaderReaderT(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect)))(changeParent(elem));
                                      return function ($228) {
                                          return $227(traverser($228));
                                      };
  ...
  var addCss = function (v) {
      ...
      throw new Error("Failed pattern match at VirtualDom (line 514, column 10 - line 516, column 23): " + [ v.constructor.name ]);
  };
  var placeNode = function (placer) {
      return function (svn) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect))))(function (v) {
              ...
              throw new Error("Failed pattern match at VirtualDom (line 467, column 3 - line 487, column 53): " + [ svn.constructor.name ]);
          });
      };
  };
  ...
  var applyPatch = function (patch) {
      ...
      throw new Error("Failed pattern match at VirtualDom (line 133, column 20 - line 148, column 19): " + [ patch.constructor.name ]);
  };
  ...
  var addAttribute = function ($copy_attr) {
      return function ($copy_elem) {
          ...
          function $tco_loop(attr, elem) {
              ...
              throw new Error("Failed pattern match at VirtualDom (line 433, column 3 - line 438, column 36): " + [ attr.constructor.name ]);
          };
          while (!$tco_done) {
              $tco_result = $tco_loop($tco_var_attr, $copy_elem);
          };
      ...
      return Data_Diff.diff(Data_Diff["$_DiffableList_2"])(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect))(function (v) {
          ...
          if (v instanceof Data_Diff.Both) {
              var $$switch = Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect))(Control_Monad_Trans_Class.lift(Control_Monad_Writer_Trans.monadTransWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString))))(Effect.monadEffect)(removeAttribute(v.value0)(elem)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect))(addAttribute(v.value1)(elem))(function () {
                      return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect))(new Data_Maybe.Just(v.value1));
                  });
              });
              if (v.value0 instanceof Attr && v.value1 instanceof Attr) {
                  var $116 = v.value0.value0 === v.value1.value0;
                  if ($116) {
                      var $117 = v.value0.value1 === v.value1.value1;
                      if ($117) {
                          return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect))(new Data_Maybe.Just(v.value0));
                      };
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect))(addAttribute(v.value1)(elem))(function () {
              ...
              if (v.value0 instanceof Prop && v.value1 instanceof Prop) {
                  var $125 = v.value0.value0 === v.value1.value0;
                  if ($125) {
                      var $126 = Data_Eq.eq(Data_JSValue["$_EqJSValue_0"])(v.value0.value1)(v.value1.value1);
                      if ($126) {
                          return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect))(new Data_Maybe.Just(v.value0));
                      };
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect))(addAttribute(v.value1)(elem))(function () {
          ...
          throw new Error("Failed pattern match at VirtualDom (line 380, column 7 - line 419, column 23): " + [ v.constructor.name ]);
      });
  };
  var vDomDiff = Data_Diff.diff(Data_Diff["$_DiffableList_2"])(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect)))(function (v) {
      ...
      throw new Error("Failed pattern match at VirtualDom (line 215, column 7 - line 223, column 40): " + [ v.constructor.name ]);
  });
                  ...
                  return function (tail2) {
                      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(diffSingle(v.value1)(newVNode1$prime))(function (newVNode1) {
                          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))((function () {
                              ...
                              throw new Error("Failed pattern match at VirtualDom (line 311, column 16 - line 313, column 27): " + [ v2.constructor.name ]);
                          })())(function (newVNode2) {
                              return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(keyedDiff(tail1)(tail2))(function (rest) {
  ...
  var keyedDiff = function (v) {
      return function (v1) {
          if (v instanceof Data_List_Types.Cons && v1 instanceof Data_List_Types.Cons) {
              var $166 = v.value0.value0 === v1.value0.value0;
              if ($166) {
              ...
              if (v.value1 instanceof Data_List_Types.Cons && v1.value1 instanceof Data_List_Types.Cons) {
                  var $169 = v.value0.value0 === Data_Tuple.fst(v1.value1.value0);
                  if ($169) {
                      var $170 = v1.value0.value0 === Data_Tuple.fst(v.value1.value0);
                      if ($170) {
                  ...
                  var $171 = v1.value0.value0 === Data_Tuple.fst(v.value1.value0);
                  if ($171) {
              ...
              if (v.value1 instanceof Data_List_Types.Cons && v1.value1 instanceof Data_List_Types.Nil) {
                  var $176 = v1.value0.value0 === Data_Tuple.fst(v.value1.value0);
                  if ($176) {
                      return keyedDiffRemove(v.value0.value1)(Data_Tuple.snd(v.value1.value0))(v1.value0)(v.value1.value1)(v1.value1);
                  };
                  return keyedDiffReplace(v.value0.value1)(v1.value0)(v.value1)(v1.value1);
              ...
              if (v.value1 instanceof Data_List_Types.Nil && v1.value1 instanceof Data_List_Types.Cons) {
                  var $179 = v.value0.value0 === Data_Tuple.fst(v1.value1.value0);
                  if ($179) {
                      return keyedDiffInsertBefore(v.value0)(Data_Tuple.snd(v1.value1.value0))(v1.value0)(v.value1)(v1.value1.value1);
                  };
                  return keyedDiffReplace(v.value0.value1)(v1.value0)(v.value1)(v1.value1);
              ...
              throw new Error("Failed pattern match at VirtualDom (line 240, column 12 - line 269, column 62): " + [ v.value1.constructor.name, v1.value1.constructor.name ]);
          };
          if (v1 instanceof Data_List_Types.Nil) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Data_Foldable.traverse_(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Writer_Trans.applicativeWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.applicativeEffect)))(Data_List_Types.foldableList)(function ($229) {
                  return removeVNode(Data_Tuple.snd($229));
              })(v))(function () {
          ...
          throw new Error("Failed pattern match at VirtualDom (line 231, column 13 - line 273, column 46): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var diffSingle = function (svn1) {
      return function (svn2) {
          var replace = (function () {
              var v = getNode(svn1);
              if (v instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(replaceNode(v.value0)(svn2))(function (svn) {
              ...
              throw new Error("Failed pattern match at VirtualDom (line 324, column 15 - line 328, column 27): " + [ v.constructor.name ]);
          })();
          if (svn1 instanceof VElement && svn2 instanceof VElement) {
              var $194 = svn1.value0.tag === svn2.value0.tag;
              if ($194) {
          ...
          if (svn1 instanceof KeyedElement && svn2 instanceof KeyedElement) {
              var $198 = svn1.value0.tag === svn2.value0.tag;
              if ($198) {
                  return Data_Maybe.fromMaybe(replace)(Control_Bind.bind(Data_Maybe.bindMaybe)(svn1.value0.node)(function (elem) {
                      return new Data_Maybe.Just(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(addCss(svn2.value0.css))(function () {
                          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Writer_Trans.bindWriterT(Data_Tuple.semigroupTuple(Data_Batched["$_SemigroupBatched_7"])(MyMap["$_SemigroupMyMap_2"](Data_Ord.ordString)))(Effect.bindEffect)))(Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Control_Monad_Writer_Trans.monadWriterT(Data_Tuple.monoidTuple(Data_Batched["$_MonoidBatched_8"])(MyMap["$_MonoidMyMap_3"](Data_Ord.ordString)))(Effect.monadEffect))(diffAttributes(elem)(svn1.value0.attributes)(svn2.value0.attributes)))(function (attributes) {
          ...
          if (svn1 instanceof VText && svn2 instanceof VText) {
              var $201 = svn1.value0.text === svn2.value0.text;
              if ($201) {
...
(function($PS) {
  ...
  var noDiff = Data_Batched.mapBoth(VirtualDom.NoDiff.create);
  var name = (function () {
...
(function($PS) {
  ...
  var inputWithHeight = Attribute.on(Producer.produceab)("input")((function () {
      var $27 = WHATWG_HTML_Types.toMaybeHTMLTextAreaElement();
      var $28 = WHATWG_DOM_Event.unsafeTarget();
      return function ($29) {
          return (function (v) {
              if (v instanceof Data_Maybe.Just) {
                  return function __do() {
                      var content = WHATWG_HTML_HTMLTextAreaElement.value(v.value0)();
                      var scrollHeight = Data_Functor.map(Effect.functorEffect)(Data_Int.toNumber)(WHATWG_DOM_Element.scrollHeight()(v.value0))();
                      var height = scrollHeight + Design.inputBoxBorderWidth;
                      var oldIb = Effect_Ref.read(ref)();
                      Effect_Ref.modify_(InputBox.update(content)(height))(ref)();
                      var helper = function (b) {
                          return function (update) {
                              return function (ma) {
                                  ...
                                  throw new Error("Failed pattern match at Input (line 87, column 15 - line 89, column 55): " + [ ma.constructor.name ]);
                              };
                          };
                      };
                      return Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(helper(content === "/edit " && InputBox.content(oldIb) === "/edit")(function (v1) {
                          return new Data_Tuple.Tuple(new Data_Maybe.Just(ModelMsg.Edit.value), v1.value1);
                      })(helper(height !== InputBox.height(oldIb))(function (v1) {
                          return new Data_Tuple.Tuple(v1.value0, height);
              ...
              throw new Error("Failed pattern match at Input (line 63, column 8 - line 100, column 33): " + [ v.constructor.name ]);
          })($27($28($29)));
      };
  })());
  var infuse = function (addIb) {
      return function (getIb) {
          return function (update) {
              return function (model) {
                  return function (msg) {
                      return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(Effect_Ref.read(ref)))(function (currentInputBox) {
                          return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(update(addIb(model)(currentInputBox))(msg))(function (newModel) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(Effect_Ref.write(getIb(newModel))(ref)))(function () {
                                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(newModel);
                              });
                          });
                      });
                  };
  ...
  var hitEnter = (function () {
      var $30 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($31) {
          return (function (v) {
              if (v instanceof Data_Maybe.Just) {
                  var $18 = WHATWG_HTML_KeyboardEvent.key(v.value0) === "Enter";
                  if ($18) {
                      return function __do() {
                          ...
                          if (v1 instanceof Data_Maybe.Just) {
                              var $20 = Data_Eq.eq(RefEq.eqRefEq)(new RefEq.RefEq(body))(new RefEq.RefEq(v1.value0));
                              if ($20) {
                          ...
                          throw new Error("Failed pattern match at Input (line 135, column 13 - line 147, column 38): " + [ v1.constructor.name ]);
                      };
                  };
                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value);
              };
              ...
              throw new Error("Failed pattern match at Input (line 129, column 6 - line 151, column 30): " + [ v.constructor.name ]);
          })($30($31));
      };
  })();
  var focusInput = Platform.afterRender(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(WHATWG_HTML_Window["document'"])((function () {
      var $32 = Data_Functor.map(Effect.functorEffect)(WHATWG_HTML_Types.toMaybeHTMLElement());
      var $33 = WHATWG_DOM_Mixin_NonElementParentNode.getElementById()(id);
      return function ($34) {
          return $32($33($34));
      };
  ...
  var detectInputEvents = Attribute.on(Producer.produceab)("keydown")((function () {
      var $35 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($36) {
          return (function (v) {
              if (v instanceof Data_Maybe.Just) {
                  var $24 = WHATWG_HTML_KeyboardEvent.key(v.value0) === "Enter" && (WHATWG_HTML_KeyboardEvent.ctrlKey(v.value0) || WHATWG_HTML_KeyboardEvent.metaKey(v.value0));
                  if ($24) {
                      return function __do() {
                          WHATWG_DOM_Event.preventDefault()(v.value0)();
                  ...
                  var $25 = WHATWG_HTML_KeyboardEvent.key(v.value0) === "z" && WHATWG_HTML_KeyboardEvent.ctrlKey(v.value0);
                  if ($25) {
                      return function __do() {
                          WHATWG_DOM_Event.preventDefault()(v.value0)();
              ...
              throw new Error("Failed pattern match at Input (line 106, column 8 - line 117, column 33): " + [ v.constructor.name ]);
          })($35($36));
      };
  })());
  var html = function (model) {
      return Html.textareaS([ Css.height(Css.px(InputBox.height(model.inputBox))), Css.flex("1"), Css.borderJ([ Css.px(Design.inputBoxBorderWidth), "solid", Design.vars.color ]), Css.padding(".45em"), Design.inputStyles, Css.borderTop("none") ])([ Attribute.id(id), Attribute.noDiff(Attribute.value(InputBox.content(model.inputBox))), inputWithHeight, detectInputEvents ])([  ]);
  };
...
(function($PS) {
  ...
  var splitEvents = Data_Foldable.foldr(Data_Foldable.foldableArray)(function (v) {
      return function (acc) {
          ...
          throw new Error("Failed pattern match at Main (line 534, column 8 - line 548, column 59): " + [ v.payload.constructor.name ]);
      };
  })(Data_Monoid.mempty(Data_Monoid.monoidRecord()(Data_Monoid.monoidRecordCons(new Data_Symbol.IsSymbol(function () {
  ...
  var onNotSelectingClick = (function () {
      var $202 = Attribute.on(Producer.produceProducer)("click");
      var $203 = Producer.producer(ModelMsg["$_EqMsg_5"])(onNotSelectingClickRE);
      return function ($204) {
          return $202($203($204));
      };
  })();
          ...
          return (function (v) {
              if (v instanceof Data_Maybe.Just) {
                  ...
                  var isChosen = (function () {
                      ...
                      throw new Error("Failed pattern match at Main (line 639, column 25 - line 650, column 42): " + [ v1.constructor.name ]);
                  })();
              ...
              throw new Error("Failed pattern match at Main (line 634, column 17 - line 680, column 36): " + [ v.constructor.name ]);
  ...
  var formatTimeDiff = function (iOld) {
      return function (iNew) {
          ...
          var $122 = Data_Int.round(seconds) < 120;
          if ($122) {
              return show$prime(seconds)("s");
          };
          var minutes = seconds / 60.0;
          var $123 = Data_Int.round(minutes) < 120;
          if ($123) {
  ...
  var threadView = function (model) {
      ...
      var messageList = (function () {
          var $205 = Data_Functor.map(Data_Functor.functorArray)(function (v) {
                  ...
                  return function (styles) {
                      return function (mes) {
                          return Html.divS([ Design.following([ Css.borderBottom("1px solid") ]), Css.position("relative"), Css.padding("3px .25em 6px .25em"), styles ])([ onNotSelectingClick((function () {
                              ...
                              var $128 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.messageParent)(new Data_Maybe.Just(mes.id));
                              if ($128) {
                              ...
                              return Html.divS([ Css.font("0.72em sans-serif"), Css.opacity("0.6"), Css.marginBottom("0.7em") ])([  ])([ Html.text(getName(mes.authorId)(model.events.folded.names)), (function (v1) {
                                  ...
                                  throw new Error("Failed pattern match at Main (line 764, column 33 - line 773, column 52): " + [ v1.constructor.name ]);
                              })(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(getParent(mes)(model.events.folded.messages))(PointFree.applySecond(function ($208) {
          ...
          var $206 = Data_Array.fromFoldable(Data_List_Types.foldableNonEmptyList);
          return function ($207) {
  ...
  var foldEvents = function ($209) {
      return (function (events) {
          return {
              ...
              messages: (function () {
                  var initialTM = TreeMap.toTreeMap(Y_Shared_Id.ordId)(Data_Functor.mapFlipped(Data_List_Types.functorList)(events.messageSend)(function ($210) {
                  ...
                  return PointFree.applySecond(Data_Foldable.foldl(Data_List_Types.foldableList)(function (acc) {
                      ...
                      return function (v) {
                          return TreeMap.removeLeafRecursive(Y_Shared_Id.ordId)(function ($211) {
                              return (function (v1) {
                                  return v1.deleted;
                              })((function (v1) {
                                  return v1.value;
  ...
  var update = Input.infuse(function (v) {
      ...
      return function (v2) {
          ...
          if (v2 instanceof ModelMsg.SendMessage) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Input.focusInput)(function () {
                  var errorMsg = {
                      inputBox: InputBox.setContent("You didn't send that message!")(v.inputBox),
                      convoId: v.convoId,
                      userId: v.userId,
                      unread: v.unread,
                      events: v.events,
                      ...
                      return Data_Maybe.fromMaybe(Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v))(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(v.events.folded.messages))(function (v3) {
                              return new Data_Maybe.Just((function () {
                                  var $164 = Data_Eq.eq(Y_Shared_Id.eqId)(v3.value.authorId)(v.userId);
                                  if ($164) {
                  ...
                  var $166 = Data_String_Utils.startsWith("/edit ")(content);
                  if ($166) {
                      return Data_Maybe.fromMaybe(Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v))(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(v.events.folded.messages))(function (v3) {
                              return new Data_Maybe.Just((function () {
                                  var $168 = Data_Eq.eq(Y_Shared_Id.eqId)(v3.value.authorId)(v.userId);
                                  if ($168) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(pushEvent(v)(function (v4) {
          ...
          if (v2 instanceof ModelMsg.UpdateInputBox) {
                  ...
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(Data_Maybe.fromMaybe(model2)(Control_Bind.bind(Data_Maybe.bindMaybe)(model2.messageParent)(function (mid) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(model2.events.folded.messages))(function (v3) {
                          return new Data_Maybe.Just((function () {
                              ...
                              return {
                                  inputBox: InputBox.setContent("/edit " + v3.value.content)(v.inputBox),
                                  convoId: model2.convoId,
                                  userId: model2.userId,
                                  unread: model2.unread,
                                  events: model2.events,
              ...
              throw new Error("Failed pattern match at Main (line 260, column 11 - line 281, column 35): " + [ v2.value0.constructor.name ]);
          };
          if (v2 instanceof ModelMsg.TransmissionReceived) {
              if (v2.value0 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))($foreign.hasFocus))(function (focused) {
                      ...
                      var model2 = {
                          ...
                          messageParent: (function () {
                              if (v.messageParent instanceof Data_Maybe.Just) {
                                  var $183 = InputBox.content(v.inputBox) === "" && TreeMap.isLeaf(Y_Shared_Id.ordId)(v.messageParent.value0)(v.events.folded.messages);
                                  if ($183) {
                                      return newThread;
                                  };
                              ...
                              throw new Error("Failed pattern match at Main (line 319, column 25 - line 330, column 45): " + [ v.messageParent.constructor.name ]);
                          })(),
                          thread: newThread,
                          unread: (function () {
                              if (focused) {
                      ...
                      return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))((function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 343, column 17 - line 345, column 41): " + [ newThread.constructor.name ]);
                      })())(function (model3) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))((function () {
                              if (firstMessage instanceof Data_Maybe.Just) {
                                  var $191 = Data_Eq.eq(Y_Shared_Id.eqId)(firstMessage.value0.authorId)(v.userId);
                                  if ($191) {
                                      return Data_Maybe.fromMaybe(Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(Data_Unit.unit))(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                                          return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(model3.events.folded.messages))(function (v3) {
                                              return new Data_Maybe.Just((function () {
                                                  ...
                                                  throw new Error("Failed pattern match at Main (line 355, column 26 - line 357, column 49): " + [ v3.parent.constructor.name ]);
                                              })());
                                          });
                                      }));
                                  };
                              ...
                              throw new Error("Failed pattern match at Main (line 347, column 15 - line 366, column 37): " + [ firstMessage.constructor.name ]);
                          })())(function () {
              ...
              throw new Error("Failed pattern match at Main (line 284, column 11 - line 370, column 34): " + [ v2.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Main (line 106, column 7 - line 376, column 21): " + [ v2.constructor.name ]);
      };
  });
