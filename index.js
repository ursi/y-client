...
(function($PS) {
  ...
  var splitEvents = Data_Foldable.foldr(Data_Foldable.foldableArray)(function (v) {
      ...
      setName: Data_List_Types.Nil.value,
      messageSend: Data_List_Types.Nil.value,
      messageDelete: Data_List_Types.Nil.value
  });
  ...
  var processEvents = function ($152) {
      return (function (events) {
          return {
              ...
              messages: (function () {
                  var initialTM = TreeMap.toTreeMap(Y_Shared_Id.ordId)(Data_Functor.mapFlipped(Data_List_Types.functorList)(events.messageSend)(function ($153) {
                  ...
                  return Data_Foldable.foldl(Data_List_Types.foldableList)(function (acc) {
                      return function (v) {
                          return TreeMap.removeLeafRecursive(Y_Shared_Id.ordId)(function ($154) {
                              return (function (v1) {
                                  return v1.deleted;
                              })((function (v1) {
                                  return v1.value;
  ...
  var inputWithHeight = Attribute.on(Producer.produceab)("input")((function () {
      var $155 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (elem) {
      ...
      var $156 = WHATWG_HTML_Types.toMaybeHTMLTextAreaElement();
      var $157 = WHATWG_DOM_Event.unsafeTarget();
      return function ($158) {
  ...
  var hitEnter = (function () {
      var $159 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (kbe) {
          var $73 = WHATWG_HTML_KeyboardEvent.key(kbe) === "Enter";
          if ($73) {
              return function __do() {
                  ...
                  return Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (activeElement) {
                      var $74 = Data_Eq.eq(RefEq.eqRefEq)(new RefEq.RefEq(body))(new RefEq.RefEq(activeElement));
                      if ($74) {
                          return function __do() {
      ...
      var $160 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($161) {
          return $159($160($161));
      };
  })();
  ...
  var formatTimeDiff = function (iOld) {
      return function (iNew) {
          ...
          var $78 = Data_Int.round(seconds) < 120;
          if ($78) {
              return show$prime(seconds)("s");
          };
          var minutes = seconds / 60.0;
          var $79 = Data_Int.round(minutes) < 120;
          if ($79) {
  ...
  var detectSendMessage = Attribute.on(Producer.produceab)("keydown")((function () {
      var $162 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (kbe) {
          var $83 = WHATWG_HTML_KeyboardEvent.key(kbe) === "Enter" && (WHATWG_HTML_KeyboardEvent.ctrlKey(kbe) || WHATWG_HTML_KeyboardEvent.metaKey(kbe));
          if ($83) {
              return function __do() {
                  WHATWG_DOM_Event.preventDefault()(kbe)();
      ...
      var $163 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($164) {
          return $162($163($164));
      };
  })());
  ...
  var addEvents = function (events) {
      return function (newEvents) {
          ...
          if (oldEnd instanceof Data_Maybe.Just && newHead instanceof Data_Maybe.Just) {
              var $92 = Data_Ord.lessThanOrEq(Y_Shared_Util_Instant.ordInstant)(oldEnd.value0.time)(newHead.value0.time);
              if ($92) {
  ...
  var update = function (v) {
      ...
      var focusInput = Platform.afterRender(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(WHATWG_HTML_Window.window)(WHATWG_HTML_Window.document))((function () {
          var $165 = Data_Functor.map(Effect.functorEffect)(WHATWG_HTML_Types.toMaybeHTMLElement());
          var $166 = WHATWG_DOM_Mixin_NonElementParentNode.getElementById()(inputId);
          return function ($167) {
              return $165($166($167));
          };
      ...
      return function (v2) {
          ...
          if (v2 instanceof SendMessage) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(focusInput)(function () {
                  var $101 = v.inputBox.content === "";
                  if ($101) {
                      return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v);
                  };
                  var $102 = v.inputBox.content === "/delete";
                  if ($102) {
                      return Data_Maybe.fromMaybe(Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v))(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(v.state.messages))(function (v3) {
                              return new Data_Maybe.Just((function () {
                                  var $104 = Data_Eq.eq(Y_Shared_Id.eqId)(v3.value.authorId)(v.userId);
                                  if ($104) {
          ...
          if (v2 instanceof UpdateInputBox) {
              ...
              if (v.thread instanceof Data_Maybe.Just && v.messageParent instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                      messageParent: v.thread,
          ...
          if (v2 instanceof TransmissionReceived) {
              if (v2.value0 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))($foreign.hasFocus))(function (focused) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(function (mes) {
                          var $115 = Data_Eq.eq(Y_Shared_Id.eqId)(mes.authorId)(v.userId);
                          if ($115) {
                              return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                          };
                          ...
                          throw new Error("Failed pattern match at Main (line 337, column 11 - line 350, column 35): " + [ model2.thread.constructor.name ]);
                      });
                  });
              };
              ...
              throw new Error("Failed pattern match at Main (line 286, column 7 - line 352, column 30): " + [ v2.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Main (line 162, column 3 - line 358, column 17): " + [ v2.constructor.name ]);
      };
  };
  var $dollar_EqMsg_52 = new Data_Eq.Eq(function (v) {
      return function (v1) {
  ...
  var nameChanger = function (model) {
      return Html.divS([ Css.margin(".3em") ])([  ])([ Html.inputS([ Design.inputStyles, Css.border("none"), Css.borderRadius("5px"), Css.padding("3px") ])([ Attribute.value(model.nameInput), Attribute.onInput(Producer.produceab)(UpdateNameInput.create) ]), Html.buttonS([ Css.marginLeft("5px") ])([ Attribute.onClick(Producer.producea($dollar_EqMsg_52))(UpdateName.value) ])([ Html.text("Update Name") ]) ]);
  };
  var onNotSelectingClick = (function () {
      var $168 = Attribute.on(Producer.produceProducer)("click");
      var $169 = Producer.producer($dollar_EqMsg_52)(onNotSelectingClickRE);
      return function ($170) {
          return $168($169($170));
      };
  })();
  var threadBar = function (model) {
      ...
      return Platform.batch([ Html.divS([ Css.margin("5px") ])([  ])([ Html.button([ Attribute.onClick(Producer.producea($dollar_EqMsg_52))(NewThread.value) ])([ Html.text("New Thread") ]) ]), Html.divS([ Css.overflow("auto"), Css.borderJ([ Design.vars.borderWidth1, "solid" ]) ])([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(leaves)(function (mid) {
          return Data_Maybe.maybe(Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]))(function (v) {
              ...
              return Html.divS([ (function () {
                  var $138 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.thread)(new Data_Maybe.Just(mid));
                  if ($138) {
  ...
  var threadView = function (model) {
      ...
      var messageList = (function () {
          var $171 = Data_Functor.map(Data_Functor.functorArray)(function (v) {
                  ...
                  return function (styles) {
                      return function (mes) {
                          return Html.divS([ Design.following([ Css.borderBottom("1px solid") ]), Css.position("relative"), Css.padding("3px .25em 6px .25em"), styles ])([ onNotSelectingClick((function () {
                              ...
                              var $144 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.messageParent)(new Data_Maybe.Just(mes.id));
                              if ($144) {
                              ...
                              })(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(getParent(mes)(model.state.messages))(PointFree.applySecond(function ($174) {
          ...
          var $172 = Data_Array.fromFoldable(Data_List_Types.foldableNonEmptyList);
          return function ($173) {
      ...
      return Html.divS([ Design.panel, Css.transform(Css_Functions.translateX(Css_Functions.calc(Css_Functions.sub("0px")(Design.vars.borderWidth1)))) ])([  ])([ (function () {
          ...
          throw new Error("Failed pattern match at Main (line 625, column 7 - line 627, column 26): " + [ mthread.constructor.name ]);
      })(), messageInput ]);
  };
