...
(function($PS) {
  ...
  var processEvents = function ($136) {
      return (function (v) {
          return {
              ...
              messages: TreeMap.toTreeMap(Y_Shared_Id.ordId)(Data_Functor.mapFlipped(Data_List_Types.functorList)(v.messageEvents)(function ($137) {
  ...
  var inputWithHeight = Attribute.on(Producer.produceab)("input")((function () {
      var $138 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (elem) {
      ...
      var $139 = WHATWG_HTML_Types.toMaybeHTMLTextAreaElement();
      var $140 = WHATWG_DOM_Event.unsafeTarget();
      return function ($141) {
  ...
  var hitEnter = (function () {
      var $142 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (kbe) {
          var $68 = WHATWG_HTML_KeyboardEvent.key(kbe) === "Enter";
          if ($68) {
              return function __do() {
                  ...
                  return Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (activeElement) {
                      var $69 = Data_Eq.eq(RefEq.eqRefEq)(new RefEq.RefEq(body))(new RefEq.RefEq(activeElement));
                      if ($69) {
                          return function __do() {
      ...
      var $143 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($144) {
          return $142($143($144));
      };
  })();
  ...
  var formatTimeDiff = function (iOld) {
      return function (iNew) {
          ...
          var $73 = Data_Int.round(seconds) < 120;
          if ($73) {
              return show$prime(seconds)("s");
          };
          var minutes = seconds / 60.0;
          var $74 = Data_Int.round(minutes) < 120;
          if ($74) {
  ...
  var detectSendMessage = Attribute.on(Producer.produceab)("keydown")((function () {
      var $145 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (kbe) {
          var $78 = WHATWG_HTML_KeyboardEvent.key(kbe) === "Enter" && (WHATWG_HTML_KeyboardEvent.ctrlKey(kbe) || WHATWG_HTML_KeyboardEvent.metaKey(kbe));
          if ($78) {
              return function __do() {
                  WHATWG_DOM_Event.preventDefault()(kbe)();
      ...
      var $146 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($147) {
          return $145($146($147));
      };
  })());
  ...
  var addEvents = function (events) {
      return function (newEvents) {
          ...
          if (oldEnd instanceof Data_Maybe.Just && newHead instanceof Data_Maybe.Just) {
              var $87 = Data_Ord.lessThanOrEq(Y_Shared_Util_Instant.ordInstant)(oldEnd.value0.time)(newHead.value0.time);
              if ($87) {
  ...
  var update = function (v) {
      ...
      var focusInput = Platform.afterRender(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(WHATWG_HTML_Window.window)(WHATWG_HTML_Window.document))((function () {
          var $148 = Data_Functor.map(Effect.functorEffect)(WHATWG_HTML_Types.toMaybeHTMLElement());
          var $149 = WHATWG_DOM_Mixin_NonElementParentNode.getElementById()(inputId);
          return function ($150) {
              return $148($149($150));
          };
      ...
      return function (v2) {
          ...
          if (v2 instanceof TransmissionReceived) {
              if (v2.value0 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))($foreign.hasFocus))(function (focused) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(function (mes) {
                          var $106 = Data_Eq.eq(Y_Shared_Id.eqId)(mes.authorId)(v.userId);
                          if ($106) {
                              return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                          };
                          return $foreign.sendNotification(getName(mes.authorId)(model2.state.names))(mes.content);
                      })(firstMessage)))(function () {
                          if (v.thread instanceof Data_Maybe.Just) {
                              var mleaf = TreeMap.findLeaf(Y_Shared_Id.ordId)(v.thread.value0)(processedEvents.messages);
                              return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))({
                                  thread: mleaf,
                                  messageParent: (function () {
                                      var $108 = v.inputBox.content === "";
                                      if ($108) {
                                          return mleaf;
                                      };
                          ...
                          throw new Error("Failed pattern match at Main (line 306, column 11 - line 319, column 35): " + [ v.thread.constructor.name ]);
                      });
                  });
              };
              ...
              throw new Error("Failed pattern match at Main (line 260, column 7 - line 321, column 30): " + [ v2.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Main (line 162, column 3 - line 327, column 17): " + [ v2.constructor.name ]);
      };
  };
  var $dollar_EqMsg_44 = new Data_Eq.Eq(function (v) {
      return function (v1) {
  ...
  var nameChanger = function (model) {
      return Html.divS([ Css.margin(".3em") ])([  ])([ Html.inputS([ Design.inputStyles, Css.border("none"), Css.borderRadius("5px"), Css.padding("3px") ])([ Attribute.value(model.nameInput), Attribute.onInput(Producer.produceab)(UpdateNameInput.create) ]), Html.buttonS([ Css.marginLeft("5px") ])([ Attribute.onClick(Producer.producea($dollar_EqMsg_44))(UpdateName.value) ])([ Html.text("Update Name") ]) ]);
  };
  var onNotSelectingClick = (function () {
      var $151 = Attribute.on(Producer.produceProducer)("click");
      var $152 = Producer.producer($dollar_EqMsg_44)(onNotSelectingClickRE);
      return function ($153) {
          return $151($152($153));
      };
  })();
  var threadBar = function (model) {
      ...
      return Platform.batch([ Html.divS([ Css.margin("5px") ])([  ])([ Html.button([ Attribute.onClick(Producer.producea($dollar_EqMsg_44))(NewThread.value) ])([ Html.text("New Thread") ]) ]), Html.divS([ Css.overflow("auto"), Css.borderJ([ Design.vars.borderWidth1, "solid" ]) ])([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(leaves)(function (mid) {
          return (function (mes) {
              return Html.divS([ (function () {
                  var $127 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.thread)(new Data_Maybe.Just(mid));
                  if ($127) {
                      return Css.background(Design.vars.accent1);
                  };
                  return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_7"]);
              })(), Design.following([ Css.borderTop("1px solid") ]), Css.padding(".3em"), Css.whiteSpace("pre-wrap"), Css.overflow("auto") ])([ onNotSelectingClick(new SelectThreadRoot(mid)) ])([ Html.text(mes) ]);
          })(Data_Maybe.maybe("oops")(function ($154) {
              return (function (v) {
                  return v.content;
              })((function (v) {
                  return v.value;
  ...
  var threadView = function (model) {
      ...
      var messageList = (function () {
          var $155 = Data_Functor.map(Data_Functor.functorArray)(function (v) {
              var createMessage = function (isSibling) {
                  return function (styles) {
                      return function (mes) {
                          return Html.divS([ Design.following([ Css.borderBottom("1px solid") ]), Css.padding(".25em"), Css.position("relative"), Css.paddingBottom("6px"), styles ])([ onNotSelectingClick((function () {
                              if (isSibling) {
                                  return SelectSibling.create;
                              };
                              return SelectMessageParent.create;
                          })()(mes.id)) ])([ (function () {
                              var $130 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.messageParent)(new Data_Maybe.Just(mes.id));
                              if ($130) {
                          ...
                          })(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(getParent(mes)(model.state.messages))(PointFree.applySecond(function ($158) {
                              return formatTimeDiff((function (v1) {
                                  return v1.timeSent;
                              })($158));
                          })(mes.timeSent))) ]), Html.divS([ Css.whiteSpace("pre-wrap"), Css.position("relative"), Css.overflowX("auto") ])([  ])([ Html.text(mes.content) ]) ]);
                      };
                  };
              };
          ...
          var $156 = Data_Array.fromFoldable(Data_List_Types.foldableNonEmptyList);
          return function ($157) {
      ...
      return Html.divS([ Design.panel, Css.transform(Css_Functions.translateX(Css_Functions.calc(Css_Functions.sub("0px")(Design.vars.borderWidth1)))) ])([  ])([ (function () {
          ...
          throw new Error("Failed pattern match at Main (line 566, column 7 - line 568, column 26): " + [ mthread.constructor.name ]);
      })(), messageInput ]);
  };
