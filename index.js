...
(function($PS) {
  ...
  var processEvents = function ($132) {
      return (function (v) {
          return {
              ...
              messages: TreeMap.toTreeMap(Y_Shared_Id.ordId)(Data_Functor.mapFlipped(Data_List_Types.functorList)(v.messageEvents)(function ($133) {
  ...
  var inputWithHeight = Attribute.on(Producer.produceab)("input")((function () {
      var $134 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (elem) {
      ...
      var $135 = WHATWG_HTML_Types.toMaybeHTMLTextAreaElement();
      var $136 = WHATWG_DOM_Event.unsafeTarget();
      return function ($137) {
          return $134($135($136($137)));
      };
  })());
  var inputId = "input";
  var hitEnter = (function () {
      var $138 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (kbe) {
          var $66 = WHATWG_HTML_KeyboardEvent.key(kbe) === "Enter";
          if ($66) {
              return function __do() {
                  ...
                  return Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (activeElement) {
                      var $67 = Data_Eq.eq(RefEq.eqRefEq)(new RefEq.RefEq(body))(new RefEq.RefEq(activeElement));
                      if ($67) {
                          return function __do() {
      ...
      var $139 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($140) {
          return $138($139($140));
      };
  })();
  var subscriptions = function (model) {
      return Platform.batch([ WebSocketSub.wsToSub(TransmissionReceived.create)(model.wsClient), Sub.on(Producer.produceab)("keydown")(hitEnter) ]);
  };
  ...
  var formatTimeDiff = function (iOld) {
      return function (iNew) {
          ...
          var $71 = Data_Int.round(seconds) < 120;
          if ($71) {
              return show$prime(seconds)("s");
          };
          var minutes = seconds / 60.0;
          var $72 = Data_Int.round(minutes) < 120;
          if ($72) {
  ...
  var detectSendMessage = Attribute.on(Producer.produceab)("keydown")((function () {
      var $141 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Maybe.Nothing.value))(function (kbe) {
          var $76 = WHATWG_HTML_KeyboardEvent.key(kbe) === "Enter" && (WHATWG_HTML_KeyboardEvent.ctrlKey(kbe) || WHATWG_HTML_KeyboardEvent.metaKey(kbe));
          if ($76) {
              return function __do() {
                  WHATWG_DOM_Event.preventDefault()(kbe)();
      ...
      var $142 = WHATWG_HTML_Types.toMaybeKeyboardEvent();
      return function ($143) {
          return $141($142($143));
      };
  })());
  ...
  var addEvents = function (events) {
      return function (newEvents) {
          ...
          if (oldEnd instanceof Data_Maybe.Just && newHead instanceof Data_Maybe.Just) {
              var $85 = Data_Ord.lessThanOrEq(Y_Shared_Util_Instant.ordInstant)(oldEnd.value0.time)(newHead.value0.time);
              if ($85) {
  ...
  var update = function (v) {
      ...
      var focusInput = Platform.afterRender(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(WHATWG_HTML_Window.window)(WHATWG_HTML_Window.document))((function () {
          var $144 = Data_Functor.map(Effect.functorEffect)(WHATWG_HTML_Types.toMaybeHTMLElement());
          var $145 = WHATWG_DOM_Mixin_NonElementParentNode.getElementById()(inputId);
          return function ($146) {
              return $144($145($146));
          };
      ...
      return function (v2) {
          ...
          if (v2 instanceof TransmissionReceived) {
              if (v2.value0 instanceof Data_Maybe.Just) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit))(function (mes) {
                      var $103 = Data_Eq.eq(Y_Shared_Id.eqId)(mes.authorId)(v.userId);
                      if ($103) {
                          return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
                      };
                      ...
                      throw new Error("Failed pattern match at Main (line 295, column 11 - line 308, column 35): " + [ v.thread.constructor.name ]);
                  });
              };
              if (v2.value0 instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v);
              };
              throw new Error("Failed pattern match at Main (line 253, column 7 - line 310, column 30): " + [ v2.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Main (line 157, column 3 - line 316, column 17): " + [ v2.constructor.name ]);
      };
  };
  var $dollar_EqMsg_42 = new Data_Eq.Eq(function (v) {
      return function (v1) {
  ...
  var nameChanger = function (model) {
      return Html.divS([ Css.margin(".3em") ])([  ])([ Html.inputS([ Design.inputStyles, Css.border("none"), Css.borderRadius("5px"), Css.padding("3px") ])([ Attribute.value(model.nameInput), Attribute.onInput(Producer.produceab)(UpdateNameInput.create) ]), Html.buttonS([ Css.marginLeft("5px") ])([ Attribute.onClick(Producer.producea($dollar_EqMsg_42))(UpdateName.value) ])([ Html.text("Update Name") ]) ]);
  };
  var onNotSelectingClick = (function () {
      var $147 = Attribute.on(Producer.produceProducer)("click");
      var $148 = Producer.producer($dollar_EqMsg_42)(onNotSelectingClickRE);
      return function ($149) {
          return $147($148($149));
      };
  })();
  var threadBar = function (model) {
      ...
      return Platform.batch([ Html.divS([ Css.margin("5px") ])([  ])([ Html.button([ Attribute.onClick(Producer.producea($dollar_EqMsg_42))(NewThread.value) ])([ Html.text("New Thread") ]) ]), Html.divS([ Css.overflow("auto"), Css.borderJ([ Design.vars.borderWidth1, "solid" ]) ])([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(leaves)(function (mid) {
          return (function (mes) {
              return Html.divS([ (function () {
                  var $124 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.thread)(new Data_Maybe.Just(mid));
                  if ($124) {
          ...
          })(Data_Maybe.maybe("oops")(function ($150) {
              return (function (v) {
                  return v.content;
              })((function (v) {
                  return v.value;
  ...
  var threadView = function (model) {
      ...
      var messageList = (function () {
          var $151 = Data_Functor.map(Data_Functor.functorArray)(function (v) {
              var createMessage = function (isSibling) {
                  return function (styles) {
                      return function (mes) {
                          ...
                          })(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(getParent(mes)(model.state.messages))(PointFree.applySecond(function ($154) {
          ...
          var $152 = Data_Array.fromFoldable(Data_List_Types.foldableNonEmptyList);
          return function ($153) {
      ...
      return Html.divS([ Design.panel, Css.transform(Css_Functions.translateX(Css_Functions.calc(Css_Functions.sub("0px")(Design.vars.borderWidth1)))) ])([  ])([ (function () {
          ...
          throw new Error("Failed pattern match at Main (line 551, column 7 - line 553, column 26): " + [ mthread.constructor.name ]);
      })(), messageInput ]);
  };
