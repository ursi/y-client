...
(function($PS) {
  ...
  var title = (function () {
      var $27 = VirtualDom.Attr.create("title");
      return function ($28) {
          return Data_Batched.Single.create($27($28));
      };
  })();
...
(function($PS) {
  ...
  var inputWithHeight = Attribute.on(Producer.produceab)("input")((function () {
      var $132 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(NoOp.value))(function (elem) {
          return Control_Apply.lift2(Effect.applyEffect)(function (content) {
              return function (height) {
                  return new UpdateInputBox({
                      content: content,
  ...
  var detectSendMessage = Attribute.on(Producer.produceab)("keydown")((function () {
      var $139 = Data_Maybe.maybe(Control_Applicative.pure(Effect.applicativeEffect)(NoOp.value))(function (kbe) {
