...
(function($PS) {
  ...
  var splitEvents = Data_Foldable.foldr(Data_Foldable.foldableArray)(function (v) {
      return function (acc) {
          ...
          throw new Error("Failed pattern match at Main (line 532, column 8 - line 546, column 59): " + [ v.payload.constructor.name ]);
      };
  })(Data_Monoid.mempty(Data_Monoid.monoidRecord()(Data_Monoid.monoidRecordCons(new Data_Symbol.IsSymbol(function () {
  ...
  var pushReadEvent = function (v) {
      return function (mid) {
          var $87 = Data_Set.member(Data_Tuple.ordTuple(Y_Shared_Id.ordId)(Y_Shared_Id.ordId))(new Data_Tuple.Tuple(v.userId, mid))(v.events.folded.read);
          if ($87) {
  ...
  var onNotSelectingClick = (function () {
      var $201 = Attribute.on(Producer.produceProducer)("click");
      var $202 = Producer.producer(ModelMsg["$_EqMsg_5"])(onNotSelectingClickRE);
      return function ($203) {
          return $201($202($203));
      };
  })();
          ...
          return (function (v) {
              if (v instanceof Data_Maybe.Just) {
                  ...
                  var isChosen = (function () {
                      ...
                      throw new Error("Failed pattern match at Main (line 637, column 25 - line 648, column 42): " + [ v1.constructor.name ]);
                  })();
                  var $101 = !isChosen && (isRead && Data_Eq.notEq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.thread)(new Data_Maybe.Just(mid))) || v.value0.value.deleted;
                  if ($101) {
                      return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_8"]);
                  };
                  return Html.divS([ (function () {
                      var $102 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.thread)(new Data_Maybe.Just(mid));
                      if ($102) {
                      ...
                      var $103 = Data_Eq.eq(Y_Shared_Id.eqId)(v.value0.value.authorId)(model.userId) || isRead;
                      if ($103) {
                          return Data_Monoid.mempty(Data_Batched["$_MonoidBatched_8"]);
                      };
              ...
              throw new Error("Failed pattern match at Main (line 632, column 17 - line 678, column 36): " + [ v.constructor.name ]);
  ...
  var formatTimeDiff = function (iOld) {
      return function (iNew) {
          ...
          var $121 = Data_Int.round(seconds) < 120;
          if ($121) {
              return show$prime(seconds)("s");
          };
          var minutes = seconds / 60.0;
          var $122 = Data_Int.round(minutes) < 120;
          if ($122) {
  ...
  var threadView = function (model) {
      ...
      var messageList = (function () {
          var $204 = Data_Functor.map(Data_Functor.functorArray)(function (v) {
                  ...
                  return function (styles) {
                      return function (mes) {
                          return Html.divS([ Design.following([ Css.borderBottom("1px solid") ]), Css.position("relative"), Css.padding("3px .25em 6px .25em"), styles ])([ onNotSelectingClick((function () {
                              ...
                              var $127 = Data_Eq.eq(Data_Maybe.eqMaybe(Y_Shared_Id.eqId))(model.messageParent)(new Data_Maybe.Just(mes.id));
                              if ($127) {
                              ...
                              return Html.divS([ Css.font("0.72em sans-serif"), Css.opacity("0.6"), Css.marginBottom("0.7em") ])([  ])([ Html.text(getName(mes.authorId)(model.events.folded.names)), (function (v1) {
                                  ...
                                  throw new Error("Failed pattern match at Main (line 762, column 33 - line 771, column 52): " + [ v1.constructor.name ]);
                              })(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(getParent(mes)(model.events.folded.messages))(PointFree.applySecond(function ($207) {
          ...
          var $205 = Data_Array.fromFoldable(Data_List_Types.foldableNonEmptyList);
          return function ($206) {
  ...
  var foldEvents = function ($208) {
      return (function (events) {
          return {
              ...
              messages: (function () {
                  var initialTM = TreeMap.toTreeMap(Y_Shared_Id.ordId)(Data_Functor.mapFlipped(Data_List_Types.functorList)(events.messageSend)(function ($209) {
                  ...
                  return PointFree.applySecond(Data_Foldable.foldl(Data_List_Types.foldableList)(function (acc) {
                      ...
                      return function (v) {
                          return TreeMap.removeLeafRecursive(Y_Shared_Id.ordId)(function ($210) {
                              return (function (v1) {
                                  return v1.deleted;
                              })((function (v1) {
                                  return v1.value;
  ...
  var addEvents = function (events) {
      return function (newEvents) {
          ...
          if (oldEnd instanceof Data_Maybe.Just && newHead instanceof Data_Maybe.Just) {
              var $151 = Data_Ord.lessThanOrEq(Y_Shared_Util_Instant.ordInstant)(oldEnd.value0.time)(newHead.value0.time);
              if ($151) {
      ...
      return function (v2) {
          ...
          if (v2 instanceof ModelMsg.SendMessage) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Input.focusInput)(function () {
                      ...
                      return Data_Maybe.fromMaybe(Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v))(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(v.events.folded.messages))(function (v3) {
                              return new Data_Maybe.Just((function () {
                                  var $163 = Data_Eq.eq(Y_Shared_Id.eqId)(v3.value.authorId)(v.userId);
                                  if ($163) {
                  ...
                  var $165 = Data_String_Utils.startsWith("/edit ")(content);
                  if ($165) {
                      return Data_Maybe.fromMaybe(Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(v))(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(v.events.folded.messages))(function (v3) {
                              return new Data_Maybe.Just((function () {
                                  var $167 = Data_Eq.eq(Y_Shared_Id.eqId)(v3.value.authorId)(v.userId);
                                  if ($167) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))(pushEvent(v)(function (v4) {
          ...
          if (v2 instanceof ModelMsg.UpdateInputBox) {
              ...
              throw new Error("Failed pattern match at Main (line 258, column 11 - line 279, column 35): " + [ v2.value0.constructor.name ]);
          };
          if (v2 instanceof ModelMsg.TransmissionReceived) {
              if (v2.value0 instanceof Data_Maybe.Just) {
                  return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))(Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))($foreign.hasFocus))(function (focused) {
                      ...
                      var model2 = {
                          ...
                          messageParent: (function () {
                              if (v.messageParent instanceof Data_Maybe.Just) {
                                  var $182 = InputBox.content(v.inputBox) === "" && TreeMap.isLeaf(Y_Shared_Id.ordId)(v.messageParent.value0)(v.events.folded.messages);
                                  if ($182) {
                                      return newThread;
                                  };
                              ...
                              throw new Error("Failed pattern match at Main (line 317, column 25 - line 328, column 45): " + [ v.messageParent.constructor.name ]);
                          })(),
                          thread: newThread,
                          unread: (function () {
                              if (focused) {
                      ...
                      return Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))((function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 341, column 17 - line 343, column 41): " + [ newThread.constructor.name ]);
                      })())(function (model3) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Writer_Trans.bindWriterT(Platform["$_SemigroupCmd_9"])(Effect.bindEffect))((function () {
                              if (firstMessage instanceof Data_Maybe.Just) {
                                  var $190 = Data_Eq.eq(Y_Shared_Id.eqId)(firstMessage.value0.authorId)(v.userId);
                                  if ($190) {
                                      return Data_Maybe.fromMaybe(Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(Data_Unit.unit))(Control_Bind.bind(Data_Maybe.bindMaybe)(v.messageParent)(function (mid) {
                                          return Control_Bind.bind(Data_Maybe.bindMaybe)(TreeMap.lookup(Y_Shared_Id.ordId)(mid)(model3.events.folded.messages))(function (v3) {
                                              return new Data_Maybe.Just((function () {
                                                  ...
                                                  throw new Error("Failed pattern match at Main (line 353, column 26 - line 355, column 49): " + [ v3.parent.constructor.name ]);
                                              })());
                                          });
                                      }));
                                  };
                                  return Effect_Class.liftEffect(Control_Monad_Writer_Trans.monadEffectWriter(Platform["$_MonoidCmd_10"])(Effect_Class.monadEffectEffect))($foreign.sendNotification(getName(firstMessage.value0.authorId)(model3.events.folded.names))(firstMessage.value0.content));
                              };
                              if (firstMessage instanceof Data_Maybe.Nothing) {
                                  return Control_Applicative.pure(Control_Monad_Writer_Trans.applicativeWriterT(Platform["$_MonoidCmd_10"])(Effect.applicativeEffect))(Data_Unit.unit);
                              };
                              throw new Error("Failed pattern match at Main (line 345, column 15 - line 364, column 37): " + [ firstMessage.constructor.name ]);
                          })())(function () {
              ...
              throw new Error("Failed pattern match at Main (line 282, column 11 - line 368, column 34): " + [ v2.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Main (line 104, column 7 - line 374, column 21): " + [ v2.constructor.name ]);
      };
  });
